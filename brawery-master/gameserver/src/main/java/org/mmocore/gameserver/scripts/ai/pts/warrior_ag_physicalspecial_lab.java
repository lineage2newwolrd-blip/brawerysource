...
public class warrior_ag_physicalspecial_lab extends warrior_physicalspecial_lab
{
	public warrior_ag_physicalspecial_lab(final NpcInstance actor){super(actor);}
