...
public class poison_predator extends warrior_aggressive_casting_curse
{
	public poison_predator(final NpcInstance actor){super(actor);}
	...
	protected void onEvtDead(Creature attacker)
	{
		...
		while (!AiUtils.IsNull(code_info = always_list.Next()))
		{
			if (code_info.getCode() == 0)
			{
				...
				{
					c1 = GetLastAttacker();
					if (AiUtils.OwnItemCount(c_quest0, 1172) > 0 && AiUtils.OwnItemCount(c_quest0, 1173) < 20 && i_quest0 == 1)
					{
