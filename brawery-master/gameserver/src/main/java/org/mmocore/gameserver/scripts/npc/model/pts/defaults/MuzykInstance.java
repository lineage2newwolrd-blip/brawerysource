        ...
        if (command.startsWith("menu_select?ask=362&")) {
            ...
            switch (getNpcId()) {
                case 31042:
                    if (command.endsWith("reply=1")) {
                        if (ItemFunctions.getItemCount(player, q_musicnote_journey) < 1) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_03.htm");
                            break;
                        ...
                        if (ItemFunctions.getItemCount(player, q_musicnote_battle) < 1) {
                            ...
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_05.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_battle) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) >= 200) {
                            ItemFunctions.addItem(player, echo_crystal_battle, 1);
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_04.htm");
                            break;
                        }
                    } else if (command.endsWith("reply=3")) {
                        if (ItemFunctions.getItemCount(player, q_musicnote_love) < 1) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_09.htm");
                            break;
                            ...
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_08.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_love) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) >= 200) {
                            ItemFunctions.addItem(player, echo_crystal_love, 1);
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_07.htm");
                            break;
                        }
                    } else if (command.endsWith("reply=4")) {
                        if (ItemFunctions.getItemCount(player, q_musicnote_solitude) < 1) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_12.htm");
                            break;
                            ...
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_11.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_solitude) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) >= 200) {
                            ItemFunctions.addItem(player, echo_crystal_solitude, 1);
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_10.htm");
                            break;
                        }
                    } else if (command.endsWith("reply=5")) {
                        if (ItemFunctions.getItemCount(player, q_musicnote_feast) < 1) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_15.htm");
                            break;
                            ...
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_14.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_feast) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) >= 200) {
                            ItemFunctions.addItem(player, echo_crystal_feast, 1);
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_13.htm");
                            break;
                        }
                        ...
                        if (ItemFunctions.getItemCount(player, q_musicnote_comedy) < 1) {
                            ...
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_16.htm");
                            break;
                        }
                        ...
                        if (ItemFunctions.getItemCount(player, q_musicnote_celebration) < 1) {
                            ...
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyk_q0362_17.htm");
                            break;
                        }
                    }
                    break;
                case 31043:
                    if (command.endsWith("reply=1")) {
                        if (ItemFunctions.getItemCount(player, q_musicnote_journey) < 1) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_03.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_journey) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) < 200) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_02.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_journey) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) >= 200) {
                            ItemFunctions.addItem(player, echo_crystal_journey, 1);
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_01.htm");
                            break;
                        }
                    } else if (command.endsWith("reply=2")) {
                        if (ItemFunctions.getItemCount(player, q_musicnote_battle) < 1) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_06.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_battle) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) < 200) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_05.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_battle) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) >= 200) {
                            ItemFunctions.addItem(player, echo_crystal_battle, 1);
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_04.htm");
                            break;
                        }
                    } else if (command.endsWith("reply=3")) {
                        if (ItemFunctions.getItemCount(player, q_musicnote_love) < 1) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_09.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_love) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) < 200) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_08.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_love) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) >= 200) {
                            ItemFunctions.addItem(player, echo_crystal_love, 1);
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_07.htm");
                            break;
                        }
                    } else if (command.endsWith("reply=4")) {
                        if (ItemFunctions.getItemCount(player, q_musicnote_solitude) < 1) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_12.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_solitude) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) < 200) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_11.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_solitude) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) >= 200) {
                            ItemFunctions.addItem(player, echo_crystal_solitude, 1);
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_10.htm");
                            break;
                        }
                    } else if (command.endsWith("reply=5")) {
                        if (ItemFunctions.getItemCount(player, q_musicnote_feast) < 1) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_15.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_feast) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) < 200) {
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_14.htm");
                            break;
                        } else if (ItemFunctions.getItemCount(player, q_musicnote_feast) > 0 && ItemFunctions.getItemCount(player, ItemTemplate.ITEM_ID_ADENA) >= 200) {
                            ItemFunctions.addItem(player, echo_crystal_feast, 1);
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_13.htm");
                            break;
                        }
                    } else if (command.endsWith("reply=6")) {
                        if (ItemFunctions.getItemCount(player, q_musicnote_comedy) < 1) {
                            ...
                            ItemFunctions.addItem(player, echo_crystal_comedy, 1);
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_16.htm");
                            break;
                        }
                    } else if (command.endsWith("reply=7")) {
                        if (ItemFunctions.getItemCount(player, q_musicnote_celebration) < 1) {
                            ...
                            ItemFunctions.addItem(player, echo_crystal_celebration, 1);
                            ItemFunctions.removeItem(player, ItemTemplate.ITEM_ID_ADENA, 200);
                            showChatWindow(player, "quests/_362_BardsMandolin/muzyko_q0362_17.htm");
                            break;
                        }
                    }
                    break;
