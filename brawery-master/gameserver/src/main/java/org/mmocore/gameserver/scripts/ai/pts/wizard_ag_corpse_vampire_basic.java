...
public class wizard_ag_corpse_vampire_basic extends wizard_corpse_vampire_basic
{
	public wizard_ag_corpse_vampire_basic(final NpcInstance actor){super(actor);}
