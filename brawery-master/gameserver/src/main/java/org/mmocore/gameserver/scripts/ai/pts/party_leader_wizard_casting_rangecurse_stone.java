...
public class party_leader_wizard_casting_rangecurse_stone extends party_leader_wizard_casting_rangecurse
{
	public int DeBuff1 = 295895041;

	public party_leader_wizard_casting_rangecurse_stone(final NpcInstance actor){super(actor);}
