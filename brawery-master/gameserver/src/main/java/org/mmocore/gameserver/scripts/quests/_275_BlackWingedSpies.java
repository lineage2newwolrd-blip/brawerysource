...
public class _275_BlackWingedSpies extends Quest {
    ...
    public static void give_Darkwing_Bat_Fang(QuestState st, double _count) {
        ...
        st.giveItems(Darkwing_Bat_Fang, (long)_count);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (cond == 2) {
            st.giveReward(ADENA_ID, 4550, true);
    ...
    public String onKill(NpcInstance npc, QuestState qs) {
        ...
        if (npcId == Darkwing_Bat && Darkwing_Bat_Fang_count < 70) {
            ...
            give_Darkwing_Bat_Fang(qs, 1*qs.getRateQuestsDrop());
            ...
            give_Darkwing_Bat_Fang(qs, 5*qs.getRateQuestsDrop());
        }
        return null;
    }
