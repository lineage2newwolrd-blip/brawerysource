...
public class ynglzu extends warrior_aggressive_casting_ddmagic
{
	public ynglzu(final NpcInstance actor){super(actor);}
	...
	protected void onEvtDead(Creature attacker)
	{
		...
		target = attacker;
		if (AiUtils.HaveMemo(target, 348)!=0 && AiUtils.GetMemoState(target, 348) == 1 && AiUtils.OwnItemCount(target, 14857) == 0)
		{
