...
public class guardian_arch_angel_r extends warrior_ag_casting_3skill_magical_r
{
	public guardian_arch_angel_r(final NpcInstance actor){super(actor);}
