...
public class SkillTable {
    ...
    public static int getSkillHashCode(final int skillId, final int skillLevel) throws NumberFormatException{
        if(skillId > 65535)
            throw new NumberFormatException("skill " + skillId + " hashCode greater than Integer.MAX_VALUE");
    ...
    public SkillEntry getSkillEntry(final int skillHashCode) {
        return skills.get(skillHashCode);
    }
