...
public class _280_TheFoodChain extends Quest {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("jager_bixon_q0280_03.htm") && _state == CREATED) {
            ...
            long Grey_Keltir_Tooth_count = st.ownItemCount(Grey_Keltir_Tooth);
            long Black_Wolf_Tooth_count = st.ownItemCount(Black_Wolf_Tooth);

            if (event.equalsIgnoreCase("ADENA")) {
                st.takeItems(Grey_Keltir_Tooth, -1);
                st.takeItems(Black_Wolf_Tooth, -1);
                st.giveReward(ADENA_ID, (Grey_Keltir_Tooth_count + Black_Wolf_Tooth_count) * 2, true);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (_state == CREATED) {
            ...
            return st.ownItemCount(Grey_Keltir_Tooth) > 0 || st.ownItemCount(Black_Wolf_Tooth) > 0 ? "jager_bixon_q0280_05.htm" : "jager_bixon_q0280_04.htm";
        }
