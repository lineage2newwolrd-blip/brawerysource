    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == wharf_soldier_orbiu) {
            ...
            if (st.ownItemCount(q_swallowed_skull) < 1 && st.ownItemCount(q_swallowed_rib) < 1 && st.ownItemCount(q_swallowed_bones) < 1)
                ...
                st.giveReward(ADENA_ID, _adenatogive, true);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (GetMemoState == 1)
            if (npcId == mutant_hawk_1lv) {
                int i0 = Rnd.get(1000);
                if (i0 < 15) {
                    st.giveItems(q_swallowed_skull, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i0 < 139) {
                    st.giveItems(q_swallowed_rib, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i0 < 965) {
                    st.giveItems(q_swallowed_bones, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                }
                ...
                if (i4 < 700) {
                    ...
                    st.giveItems(q_swallowed_skull, 2, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i4 < 949) {
                    st.giveItems(q_swallowed_skull, 3, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i4 < 966) {
                    st.giveItems(q_swallowed_skull, Rnd.get(5) + 4, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i4 < 985) {
                    st.giveItems(q_swallowed_skull, Rnd.get(9) + 4, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i4 < 993) {
                    st.giveItems(q_swallowed_skull, Rnd.get(7) + 13, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i4 < 997) {
                    st.giveItems(q_swallowed_skull, Rnd.get(15) + 9, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i4 < 999) {
                    st.giveItems(q_swallowed_skull, Rnd.get(23) + 53, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i4 < 1000) {
                    st.giveItems(q_swallowed_skull, Rnd.get(49) + 76, true);
                    st.soundEffect(SOUND_ITEMGET);
                }
                ...
                if (i5 < 520) {
                    ...
                    st.giveItems(q_swallowed_rib, 2, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i5 < 836) {
                    st.giveItems(q_swallowed_rib, 3, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i5 < 985) {
                    st.giveItems(q_swallowed_rib, Rnd.get(2) + 4, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i5 < 995) {
                    st.giveItems(q_swallowed_rib, Rnd.get(4) + 5, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i5 < 1000) {
                    st.giveItems(q_swallowed_rib, Rnd.get(8) + 6, true);
                    st.soundEffect(SOUND_ITEMGET);
                }

                if (i6 < 185) {
                    st.giveItems(q_swallowed_bones, Rnd.get(2) + 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i6 < 370) {
                    st.giveItems(q_swallowed_bones, Rnd.get(6) + 2, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i6 < 570) {
                    st.giveItems(q_swallowed_bones, Rnd.get(6) + 7, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i6 < 850) {
                    st.giveItems(q_swallowed_bones, Rnd.get(6) + 12, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i6 < 1000) {
                    st.giveItems(q_swallowed_bones, Rnd.get(2) + 17, true);
                    st.soundEffect(SOUND_ITEMGET);
                }
            }
        return null;
