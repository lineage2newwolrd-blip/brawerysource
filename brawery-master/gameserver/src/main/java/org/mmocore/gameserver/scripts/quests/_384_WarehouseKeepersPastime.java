...
public class _384_WarehouseKeepersPastime extends Quest {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        long medals = st.ownItemCount(Warehouse_Keepers_Medal);
    ...
    public String onKill(NpcInstance npc, QuestState qs) {
        ...
        if (chance != null && Rnd.chance(chance)) {
            qs.giveItems(Warehouse_Keepers_Medal, 1, true);
            qs.soundEffect(qs.ownItemCount(Warehouse_Keepers_Medal) >= 10 ? SOUND_MIDDLE : SOUND_ITEMGET);
        }
    ...
    public static class Bingo extends org.mmocore.gameserver.scripts.quests.Bingo {
        ...
        private final static String template_choice = "<a action=\"bypass -h npc_%objectId%_QuestEvent _384_WarehouseKeepersPastime choice-%n%\">%n%</a>&nbsp;&nbsp;&nbsp;&nbsp;  ";
