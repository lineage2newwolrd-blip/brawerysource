...
public class ai_boss03_raikel extends warrior_passive_casting_enchant_clan
{
	...
	public ai_boss03_raikel(final NpcInstance actor)
	{
		super(actor);
		Buff = 264110083;
	}
	...
	protected void onEvtSpawn()
	{
		...
		AddTimerEx(5001, 90000 + AiUtils.Rand(240000));
		super.onEvtSpawn();
	}
	...
	protected void onEvtAttacked(Creature attacker, int skill_name_id, int skill_id, int damage)
	{
		...
		if (actor.getMaxHp() / 2 > actor.currentHp)
		{
			if (Skill_GetConsumeMP(295960577/*@skill_4516_1*/) < actor._currentMp && Skill_GetConsumeHP(295960577/*@skill_4516_1*/) < actor.currentHp && Skill_InReuseDelay(295960577/*@skill_4516_1*/) == 0)
			{
				AddUseSkillDesire(actor, 295960577/*@skill_4516_1*/, DesireType.HEAL, DesireMove.MOVE_TO_TARGET, 1000000);
			}
		}
	}
