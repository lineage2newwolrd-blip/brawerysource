...
public class warrior_party_leader_named_monster extends party_leader_aggressive
{
	...
	public int PhysicalSpecial3 = 458752001;
	public String maker_name = "innadril22_2422_024m3";

	public warrior_party_leader_named_monster(final NpcInstance actor){super(actor);}
	...
	protected void onEvtSpawn()
	{
		...
		CreateOnePrivateEx(22300, "warrior_use_skill", 0, 0, AiUtils.FloatToInt(actor.getX() + 20), AiUtils.FloatToInt(actor.getY()), AiUtils.FloatToInt(actor.getZ()), 0, 0, 0, 0);
		CreateOnePrivateEx(22300, "warrior_use_skill", 0, 0, AiUtils.FloatToInt(actor.getX()), AiUtils.FloatToInt(actor.getY() + 20), AiUtils.FloatToInt(actor.getZ()), 0, 0, 0, 0);
	}
	...
	protected void onEvtAttacked(Creature attacker, int skill_name_id, int skill_id, int damage)
	{
		...
		{
			AddUseSkillDesire(attacker, PhysicalSpecial3, DesireType.ATTACK, DesireMove.MOVE_TO_TARGET, 1000000);
		}
	...
	protected void onEvtDead(Creature attacker)
	{
		...
		{
			AiUtils.SendMakerScriptEvent(maker0, 12547, 0, 0);
		}
