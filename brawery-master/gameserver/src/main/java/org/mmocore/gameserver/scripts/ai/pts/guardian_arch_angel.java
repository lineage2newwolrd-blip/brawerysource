...
public class guardian_arch_angel extends warrior_aggressive_casting_3skill_approach_revival
{
	public guardian_arch_angel(final NpcInstance actor){super(actor);}
