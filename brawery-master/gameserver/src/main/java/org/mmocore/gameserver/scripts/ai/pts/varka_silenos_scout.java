...
public class varka_silenos_scout extends warrior_ag_berserker_physicalspecial_stone
{
	public varka_silenos_scout(final NpcInstance actor){super(actor);}
	...
	protected void onEvtDead(Creature attacker)
	{
		...
		target = attacker;
		if (AiUtils.HaveMemo(target, 605) == 1 && ((((((AiUtils.OwnItemCount(target, 7211) + AiUtils.OwnItemCount(target, 7212) + AiUtils.OwnItemCount(target, 7213) + AiUtils.OwnItemCount(target, 7214) + AiUtils.OwnItemCount(target, 7215)) == 0 && AiUtils.OwnItemCount(target, 7216) < 100) || (AiUtils.OwnItemCount(target, 7211) >= 1 && AiUtils.OwnItemCount(target, 7216) < 200)) || (AiUtils.OwnItemCount(target, 7212) >= 1 && AiUtils.OwnItemCount(target, 7216) < 300)) || (AiUtils.OwnItemCount(target, 7213) >= 1 && AiUtils.OwnItemCount(target, 7216) < 300)) || (AiUtils.OwnItemCount(target, 7214) >= 1 && AiUtils.OwnItemCount(target, 7216) < 400)))
		{
		...
		target = attacker;
		if (AiUtils.HaveMemo(target, 606) == 1 && AiUtils.GetMemoState(target, 606) == (1 * 10 + 1))
		{
