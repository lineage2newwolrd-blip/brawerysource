...
public class warrior_aggressive_casting_splash extends warrior_casting_splash
{
	public warrior_aggressive_casting_splash(final NpcInstance actor){super(actor);}
