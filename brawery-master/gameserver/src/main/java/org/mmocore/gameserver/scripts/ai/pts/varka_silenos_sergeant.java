...
public class varka_silenos_sergeant extends warrior_ag_berserker_physicalspecial_stone
{
	public varka_silenos_sergeant(final NpcInstance actor){super(actor);}
