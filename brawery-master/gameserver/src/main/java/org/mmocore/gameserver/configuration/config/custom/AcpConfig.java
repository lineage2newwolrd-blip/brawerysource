...
public class AcpConfig {
    ...
    @Setting(increase = 1, minValue = 500, maxValue = 120000)
    ...
    @Setting(increase = 1, minValue = 500)
    public static int reuseCp;
    @Setting(increase = 1, minValue = 1000)
    public static int reuseHp;
    @Setting(increase = 1, minValue = 1)
    ...
    public static boolean acpUsePremium;
    public static boolean acpUseCert;
    public static int certItemId;
}
