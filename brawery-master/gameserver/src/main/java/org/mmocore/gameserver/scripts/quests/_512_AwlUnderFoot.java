        ...
        switch (isAvailableFor(st.getPlayer())) {
            ...
            default:
                ...
                if (st.ownItemCount(FragmentOfTheDungeonLeaderMark) > 0) {
                    st.giveReward(KnightsEpaulette, st.ownItemCount(FragmentOfTheDungeonLeaderMark), false);
                        ...
                        if (party != null) {
                            ...
                            if (!players.isEmpty()) {
                                ...
                                for (QuestState qs : players) {
                                    qs.giveItems(FragmentOfTheDungeonLeaderMark, itemCount, true);
                                ...
                                st.giveItems(FragmentOfTheDungeonLeaderMark, RewardMarksCount, true);
