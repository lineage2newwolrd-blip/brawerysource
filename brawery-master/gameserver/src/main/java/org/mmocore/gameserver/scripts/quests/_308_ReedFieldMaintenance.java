        ...
        if (npcId == contract_worker)
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (st.ownItemCount(q308_leather_of_murcrokian1) + st.ownItemCount(q308_leather_of_murcrokian2) * 2 >= 192) {
                    st.giveReward(rp_sealed_dynasty_earring_i, 1, true);
                ...
                if (st.ownItemCount(q308_leather_of_murcrokian1) + st.ownItemCount(q308_leather_of_murcrokian2) * 2 >= 256) {
                    st.giveReward(rp_sealed_dynasty_neckalce_i, 1, true);
                ...
                if (st.ownItemCount(q308_leather_of_murcrokian1) + st.ownItemCount(q308_leather_of_murcrokian2) * 2 >= 128) {
                    ...
                    st.giveReward(rp_sealed_dynasty_ring_i, 1, true);
                ...
                if (st.ownItemCount(q308_leather_of_murcrokian1) + st.ownItemCount(q308_leather_of_murcrokian2) * 2 >= 206) {
                    st.giveReward(rp_sealed_dynasty_sigil_i, 1, true);
                ...
                if (st.ownItemCount(q308_leather_of_murcrokian1) + st.ownItemCount(q308_leather_of_murcrokian2) * 2 >= 180) {
                    ...
                    switch (i0) {
                        case 0: {
                            st.giveReward(rp_sealed_destino_circlet_i, 1, true);
                            break;
                        }
                        case 1: {
                            st.giveReward(rp_sealed_destino_jaket_i, 1, true);
                            break;
                        }
                        case 2: {
                            st.giveReward(rp_sealed_destino_hose_i, 1, true);
                            break;
                        }
                        case 3: {
                            st.giveReward(rp_sealed_destino_gloves_i, 1, true);
                            break;
                        }
                        case 4: {
                            st.giveReward(rp_sealed_destino_shoes_i, 1, true);
                            break;
                        }
                        case 5: {
                            st.giveReward(rp_sealed_destino_sigil_i, 1, true);
                            break;
                        }
                        case 6: {
                ...
                if (st.ownItemCount(q308_leather_of_murcrokian1) + st.ownItemCount(q308_leather_of_murcrokian2) * 2 >= 100) {
                    for (int i1 = 0; i1 < 5; i1 = i1 + 1) {
                        ...
                        switch (i0) {
                            case 0: {
                                st.giveReward(sealed_destino_circlet_piece, 1, true);
                                break;
                            }
                            case 1: {
                                st.giveReward(sealed_destino_jaket_piece, 1, true);
                                break;
                            }
                            case 2: {
                                st.giveReward(sealed_destino_hose_piece, 1, true);
                                break;
                            }
                            case 3: {
                                st.giveReward(sealed_destino_gloves_piece, 1, true);
                                break;
                            }
                            case 4: {
                                st.giveReward(sealed_destino_shoes_piece, 1, true);
                                break;
                            }
                            case 5: {
                                st.giveReward(sealed_destino_sigil_piece, 1, true);
                                break;
                            }
                            case 6: {
                                st.giveReward(sealed_destino_ring_gem, 1, true);
                                break;
                            }
                            case 7: {
                                st.giveReward(sealed_destino_earring_gem, 1, true);
                                break;
                            }
                            case 8: {
                                st.giveReward(sealed_destino_necklace_gem, 1, true);
                                break;
                            }
                        }
                    }
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (GetMemoState == 1)
            if (npcId == murcrokian_fanatic) {
                int i0 = Rnd.get(1000);
                if (i0 < 218) {
                    st.giveItems(q308_leather_of_murcrokian1, 1, true);
                ...
                int i0 = Rnd.get(1000);
                if (i0 < 124) {
                    st.giveItems(q308_leather_of_murcrokian2, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                }
            }
        return null;
