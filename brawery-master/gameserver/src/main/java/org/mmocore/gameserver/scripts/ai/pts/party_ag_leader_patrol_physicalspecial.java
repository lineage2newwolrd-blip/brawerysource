...
public class party_ag_leader_patrol_physicalspecial extends party_leader_patrol_physicalspecial
{
	public party_ag_leader_patrol_physicalspecial(final NpcInstance actor){super(actor);}
