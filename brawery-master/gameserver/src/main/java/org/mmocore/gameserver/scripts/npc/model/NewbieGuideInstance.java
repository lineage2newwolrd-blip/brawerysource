                ...
                switch (getNpcId()) {
                    ...
                    case 30599:
                        if (player.getPlayerTemplateComponent().getPlayerRace() != PlayerRace.elf)
                            ...
                            showChatWindow(player, "quests/_041_GuideMission/guide_elf_roios/guide_elf_roios002.htm");
                        else if (player.getPlayerClassComponent().getClassId().level() == 0) {
                            if (!player.isMageClass()) {
                                if (player.getLevel() <= 5)
                    ...
                    case 30600:
                        if (player.getPlayerTemplateComponent().getPlayerRace() != PlayerRace.darkelf)
                            ...
                            showChatWindow(player, "quests/_041_GuideMission/guide_delf_frankia/guide_delf_frankia002.htm");
                        else if (player.getPlayerClassComponent().getClassId().level() == 0) {
                            if (!player.isMageClass()) {
                                if (player.getLevel() <= 5)
                    ...
                    case 30601:
                        if (player.getPlayerTemplateComponent().getPlayerRace() != PlayerRace.dwarf)
                            ...
                            showChatWindow(player, "quests/_041_GuideMission/guide_dwarf_gullin/guide_dwarf_gullin002.htm");
                        else if (player.getPlayerClassComponent().getClassId().level() == 0) {
                            if (player.getLevel() <= 5)
                    ...
                    case 30602:
                        if (player.getPlayerTemplateComponent().getPlayerRace() != PlayerRace.orc)
                            ...
                            showChatWindow(player, "quests/_041_GuideMission/guide_orc_tanai/guide_orc_tanai002.htm");
                        else if (player.getPlayerClassComponent().getClassId().level() == 0) {
                            if (!player.isMageClass()) {
                                if (player.getLevel() <= 5)
                    ...
                    case 32135:
                        if (player.getPlayerTemplateComponent().getPlayerRace() != PlayerRace.kamael)
                            ...
                            showChatWindow(player, "quests/_041_GuideMission/guide_krenisk/guide_krenisk002.htm");
