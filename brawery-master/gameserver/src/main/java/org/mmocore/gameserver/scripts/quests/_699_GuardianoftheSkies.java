            ...
            case STARTED:
                if (npcId == engineer_recon) {
                    if (GetMemoState == 1 && st.ownItemCount(q_gold_feather_of_vulture) < 1)
                        ...
                        st.giveReward(ADENA_ID, st.ownItemCount(q_gold_feather_of_vulture) * 1500, true);
                        ...
                        st.giveReward(ADENA_ID, st.ownItemCount(q_gold_feather_of_vulture) * 1500 + 8335, true);
                        st.takeItems(q_gold_feather_of_vulture, -1);
                        htmltext = "engineer_recon_q0699_06.htm";
                    }
                }
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (GetMemoState == 1) {
            if (npcId == vulture_rider_1lv) {
                int i0 = Rnd.get(1000);
                if (i0 < 840) {
                    st.giveItems(q_gold_feather_of_vulture, 1, true);
