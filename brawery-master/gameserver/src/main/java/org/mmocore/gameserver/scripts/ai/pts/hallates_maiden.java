...
public class hallates_maiden extends warrior_ag_casting_3skill_magical
{
	public hallates_maiden(final NpcInstance actor){super(actor);}
			...
			switch (code_info.getCode())
			{
				case 0:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						...
						if (i4 < 45)
						{
							GiveItem1(target, 6007, 1);
							SoundEffect(target, "ItemSound.quest_itemget");
						}
						else if (i4 < 65)
						{
							GiveItem1(target, 6018, 1);
							SoundEffect(target, "ItemSound.quest_itemget");
						}
					}
					break;
