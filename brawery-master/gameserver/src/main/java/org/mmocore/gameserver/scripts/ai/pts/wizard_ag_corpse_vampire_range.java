...
public class wizard_ag_corpse_vampire_range extends wizard_corpse_vampire_range
{
	public wizard_ag_corpse_vampire_range(final NpcInstance actor){super(actor);}
