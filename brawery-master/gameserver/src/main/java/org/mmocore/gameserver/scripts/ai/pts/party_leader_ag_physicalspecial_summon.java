...
public class party_leader_ag_physicalspecial_summon extends party_leader_physicalspecial_summon
{
	public party_leader_ag_physicalspecial_summon(final NpcInstance actor){super(actor);}
