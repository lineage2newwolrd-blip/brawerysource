...
public class party_private_ag_casting_ddmagic_curse_stone extends party_private_casting_ddmagic_curse_stone
{
	public int MeleeAttackerAg = -1;

	public party_private_ag_casting_ddmagic_curse_stone(final NpcInstance actor){super(actor);}
