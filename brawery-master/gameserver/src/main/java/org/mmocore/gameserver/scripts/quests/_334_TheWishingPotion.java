                ...
                switch (i0) {
                    ...
                    case 1:
                        if (myself_i_quest0 == 1) {
                            ...
                            st.soundEffect(SOUND_ITEMGET);
                            st.giveReward(ADENA_ID, 10000, true);
                        } else if (myself_i_quest0 == 3) {
            ...
            case STARTED:
                if (npcId == alchemist_matild) {
                    ...
                    if (st.ownItemCount(q_fobbiden_love_scroll) >= 1) {
                        st.giveReward(ADENA_ID, 500000, true);
        ...
        if (npcId == whispering_wind) {
            ...
            if (GetMemoState == 2 && talker_flag == 2) {
                if (Rnd.get(1000) < 33) {
                    int i0 = Rnd.get(1000);
                    if (i0 == 0)
                        st.giveReward(ADENA_ID, 100000000, false);
                    else
                        st.giveReward(ADENA_ID, 900000, false);
                    st.soundEffect(SOUND_ITEMGET);
                }
                grima_count++;
                if (grima_count == 3) {
            ...
            if (GetMemoState == 2 && talker_flag == 3) {
                st.giveReward(ADENA_ID, 1406956, false);
                st.soundEffect(SOUND_ITEMGET);
                talker_flag = 0;
                myself_av_quest0 = 0;
