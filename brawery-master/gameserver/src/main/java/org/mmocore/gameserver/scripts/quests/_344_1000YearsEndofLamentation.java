            ...
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (st.ownItemCount(q0344_left_thing_of_heroes) > 0) {
                    if (Rnd.get(1000) >= st.ownItemCount(q0344_left_thing_of_heroes)) {
                        st.giveReward(ADENA_ID, st.ownItemCount(q0344_left_thing_of_heroes) * 60, true);
            ...
            case STARTED:
                if (npcId == watcher_antaras_gilmore) {
                    if (GetMemoState == 0) {
                        ...
                        if (GetMemoState == 5) {
                            st.giveReward(ADENA_ID, GetMemoStateEx * 50 + 1500, true);
                        } else if (GetMemoState == 6) {
                            st.giveReward(ADENA_ID, GetMemoStateEx * 50, true);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == cave_servant || npcId == cave_servant_hold) {
            if (GetMemoState == 1 || GetMemoState == 2) {
                if (Rnd.get(100) < 58) {
                    st.giveItems(q0344_left_thing_of_heroes, 1, true);
