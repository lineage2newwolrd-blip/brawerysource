...
public class SpawnTemplate {
    ...
    private boolean rndPos;

    public SpawnTemplate(final PeriodOfDay periodOfDay, final int count, final int respawn, final int respawnRandom, final boolean rndPos) {
