                ...
                if (npcId == master_sione) {
                    ...
                    if (GetMemoState < 3)
                        ...
                        if (GetOneTimeQuestFlag == 0) {
                            ...
                            st.giveReward(ADENA_ID, 163800, true);
                        }
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == ol_mahum_patrol) {
            if (GetMemoState == 2 && st.ownItemCount(q_almaum_army_chart) < 5) {
                st.giveItems(q_almaum_army_chart, 1, true);
            ...
            if (GetMemoState == 2 && st.ownItemCount(q_almaum_order_doc) < 10) {
                st.giveItems(q_almaum_order_doc, 1, true);
                if (st.ownItemCount(q_almaum_order_doc) >= 10 && st.ownItemCount(q_almaum_army_chart) >= 5) {
                    st.setCond(3);
                    st.soundEffect(SOUND_MIDDLE);
                } else
