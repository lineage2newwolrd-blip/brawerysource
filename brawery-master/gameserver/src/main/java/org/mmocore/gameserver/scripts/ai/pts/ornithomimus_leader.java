...
public class ornithomimus_leader extends roamer_primeval
{
	public ornithomimus_leader(final NpcInstance actor){super(actor);}
			...
			switch (code_info.getCode())
			{
				case 0:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						...
						if (i4 < 661 && AiUtils.OwnItemCount(target, 8779) <= 1)
						{
				...
				case 1:
				{
					...
					{
						i4 = AiUtils.Rand(1000);
						if (i4 < 660 && AiUtils.OwnItemCount(target, 8770) <= 9)
						{
