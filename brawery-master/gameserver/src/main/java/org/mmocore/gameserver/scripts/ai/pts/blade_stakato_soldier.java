...
public class blade_stakato_soldier extends warrior_aggressive_casting_curse
{
	public blade_stakato_soldier(final NpcInstance actor){super(actor);}
	...
	protected void onEvtDead(Creature attacker)
	{
		...
		target = attacker;
		if (AiUtils.HaveMemo(target, 368)!=0)
		{
