...
public class CommandChannel implements PlayerGroup {
    ...
    public static boolean checkAuthority(final Player creator) {
        // CC могут создавать только лидеры партий
        ...
        final boolean haveSkill = creator.getClan() != null && creator.getPledgeClass() >= Player.RANK_WISEMAN && creator.getSkillLevel(CLAN_IMPERIUM_ID) > 0;
