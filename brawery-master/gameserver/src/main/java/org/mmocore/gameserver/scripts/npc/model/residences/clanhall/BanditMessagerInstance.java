...
public class BanditMessagerInstance extends NpcInstance {
    ...
    private boolean checkCond(Player player, boolean regMenu) {
        ...
        if (siegeEvent.isRegistrationOver()) {
            showChatWindow(player, "quests/_504_CompetitionForTheBanditStronghold/azit_messenger_q0504_03.htm", "%siege_time%", TimeUtils.dateTimeFormat(clanHall.getSiegeDate()));
            return false;
        }
