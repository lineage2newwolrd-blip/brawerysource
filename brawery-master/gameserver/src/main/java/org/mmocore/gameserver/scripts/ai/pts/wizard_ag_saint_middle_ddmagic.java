...
public class wizard_ag_saint_middle_ddmagic extends wizard_saint_middle_ddmagic
{
	public wizard_ag_saint_middle_ddmagic(final NpcInstance actor){super(actor);}
