        ...
        if (event.equalsIgnoreCase("reply_3")) {
            ...
            switch (npc.getNpcId()) {
                ...
                case falsepriest_dominic:
                    ...
                    break;
                case chichirin:
                    st.giveReward(ADENA_ID, 169442, true);
                    st.addExpAndSp(19408, 47062);
                    htmltext = "chichirin_q0464_02.htm";
                    break;
                case master_tobias:
                    st.giveReward(ADENA_ID, 210806, true);
