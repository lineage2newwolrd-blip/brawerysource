...
public class wizard_casting_clanbuff_rangecurse_stone extends wizard_casting_clanbuff_rangecurse
{
	public int DeBuff1 = 295895041;

	public wizard_casting_clanbuff_rangecurse_stone(final NpcInstance actor){super(actor);}
