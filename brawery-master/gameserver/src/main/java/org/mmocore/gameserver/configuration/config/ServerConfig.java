...
public class ServerConfig {
    ...
    public static boolean XML_RPC_SERVER_ENABLED = false;
    ...
    @Setting(name = "XmlRpcLogin", canNull = true)
    public static String XML_RPC_USER;
    @Setting(name = "XmlRpcPassword", canNull = true)
    ...
    @Setting(name = "RateDropHerb")
    public static double RATE_DROP_HERB;
    ...
    @Setting(name = "RateTWBadges")
    public static double RATE_TW_BADGES;
    ...
    @Setting(name = "HideSpam")
    public static boolean HIDE_SPAM_MSG;
    ...
    @Setting(name = "ScheduledMovePoolSize", method = "scheduledMovePoolSize")
    public static int SCHEDULED_MOVE_POOL_SIZE;
    @Setting(name = "ExecutorMovePoolSize", method = "executorMovePoolSize")
    public static int EXECUTOR_MOVE_POOL_SIZE;
    @Setting(name = "ExecutorBroadcastPoolSize", method = "executorBroadcastPoolSize")
    public static int EXECUTOR_BROADCAST_POOL_SIZE;
    ...
    @Setting(name = "DelayedSpawn")
    public static boolean DELAYEDSPAWN;
    ...
    private void scheduledMovePoolSize(final int value) {
        int val = value;
        if (val <= 0) {
            val = NCPUS * 4;
        }
        SCHEDULED_MOVE_POOL_SIZE = val;
    }

    private void executorMovePoolSize(final int value) {
        int val = value;
        if (val <= 0) {
            val = NCPUS * 2;
        }
        EXECUTOR_MOVE_POOL_SIZE = val;
    }

    private void executorBroadcastPoolSize(final int value) {
        int val = value;
        if (val <= 0) {
            val = NCPUS * 2;
        }
        EXECUTOR_BROADCAST_POOL_SIZE = val;
    }
    ...
    public void addStatCreature(final String value) {
        ...
        for (final String typeBlock : typeCreatureBlock) {
            ...
            list.add(new ImmutablePair<>(statCreature, types));
        }
