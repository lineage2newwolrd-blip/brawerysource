...
public class wizard_ag_casting_clanbuff_rangedd_curse_stone extends wizard_casting_clanbuff_rangedd_curse_stone
{
	public int MeleeAttackerAg = -1;

	public wizard_ag_casting_clanbuff_rangedd_curse_stone(final NpcInstance actor){super(actor);}
