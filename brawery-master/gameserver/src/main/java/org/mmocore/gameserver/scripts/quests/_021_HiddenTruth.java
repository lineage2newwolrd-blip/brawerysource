...
public class _021_HiddenTruth extends Quest {
    ...
    // value spawn mob
    private static int count_rune_ghost1b = 0;
    private static final SuperPoint SuperPoint_rune_ghost1b = SuperPointHolder.getInstance().getSuperPointsByName("rune_ghost1b");
                ...
                if (npcId == shadow_hardin) {
                    ...
                    if (GetMemoState == 3) {
                        if (spawned_rune_ghost1b == 1) {
                            ...
                            st.startQuestTimer("2105", 3000, npc);
                        }
                    }
                } else if (npcId == broken_desk1) {
                    if (GetMemoState == 3) {
