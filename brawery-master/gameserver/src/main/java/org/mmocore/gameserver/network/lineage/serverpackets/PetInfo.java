...
public class PetInfo extends GameServerPacket {
    ...
    public PetInfo(final Servitor summon) {
        ...
        speed_atack = summon.getAttackSpeedMultiplier();
        runSpd = (int) (summon.getRunSpeed() / speed_move);
        walkSpd = (int) (summon.getWalkSpeed() / speed_move);;
        ...
        if (summon.getPlayer().isInFightClub())
        {
            ...
            name = fightClubEvent.getVisibleName(summon.getPlayer(), name, false);
