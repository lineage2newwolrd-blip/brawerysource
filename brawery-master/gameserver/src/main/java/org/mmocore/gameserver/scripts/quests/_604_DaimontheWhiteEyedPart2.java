        ...
        if (npcId == eye_of_argos) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (st.ownItemCount(q_essense_of_daimon) >= 1) {
                    ...
                    if (i1 < 167)
                        st.giveReward(dye_i2m2_c, 5, true);
                    else if (i1 < 167 + 167)
                        st.giveReward(dye_i2w2_c, 5, true);
                    else if (i1 < 167 + 167 + 167)
                        st.giveReward(dye_m2i2_c, 5, true);
                    else if (i1 < 167 + 167 + 167 + 167)
                        st.giveReward(dye_m2w2_c, 5, true);
                    else if (i1 < 167 + 167 + 167 + 167 + 167)
                        st.giveReward(dye_w2i2_c, 5, true);
                    else if (i1 < 167 + 167 + 167 + 167 + 167 + 165)
                        st.giveReward(dye_w2m2_c, 5, true);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (GetMemoState >= 2 * 10 - 9 && GetMemoState <= 2 * 10 + 1)
            if (npcId == daemon_of_hundred_eyes) {
                int i4 = Rnd.get(1000);
                if (i4 < 1000)
                    if (st.ownItemCount(q_essense_of_daimon) + 1*st.getRateQuestsDrop() >= 1) {
                        st.setCond(3);
                        ...
                        st.giveItems(q_essense_of_daimon, 1, true);
