    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("eye_of_argos_q0602_0104.htm")) {
            ...
            if (st.ownItemCount(q_dark_eye) >= 100) {
                ...
                if (i1 < 200) {
                    st.giveReward(sealed_ring_of_aurakyria_gem, 3, true);
                    st.giveReward(ADENA_ID, 40000, true);
                    st.addExpAndSp(120000, 20000);
                } else if (i1 < 200 + 200) {
                    st.giveReward(sealed_sanddragons_earing_piece, 3, true);
                    st.giveReward(ADENA_ID, 60000, true);
                    st.addExpAndSp(110000, 15000);
                } else if (i1 < 200 + 200 + 100) {
                    st.giveReward(sealed_dragon_necklace_wire, 3, true);
                    st.giveReward(ADENA_ID, 40000, true);
                    st.addExpAndSp(150000, 10000);
                } else if (i1 < 200 + 200 + 100 + 500) {
                    st.giveReward(ADENA_ID, 100000, true);
