        ...
        if (player.getActiveReflection().getInstancedZoneId() == zone_id) {
            ...
            if (quest != null && quest.isCompleted()) {
                if (getNpcId() == future_door_cont) {
                    showChatWindow(player, "quests/_179_IntoTheLargeCavern/future_door_cont_q0179_02.htm");
                } else if (getNpcId() == past_door_cont) {
                    showChatWindow(player, "quests/_179_IntoTheLargeCavern/past_door_cont_q0179_02.htm");
                } else if (getNpcId() == present_door_cont) {
                    showChatWindow(player, "quests/_179_IntoTheLargeCavern/present_door_cont_q0179_02.htm");
                }
            } else {
