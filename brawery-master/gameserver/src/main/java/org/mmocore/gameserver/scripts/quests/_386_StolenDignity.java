...
public class _386_StolenDignity extends Quest {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        if (event.equalsIgnoreCase("warehouse_keeper_romp_q0386_05.htm")) {
            ...
            if (st.ownItemCount(Stolen_Infernium_Ore) < Required_Stolen_Infernium_Ore) {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        return st.ownItemCount(Stolen_Infernium_Ore) < Required_Stolen_Infernium_Ore ? "warehouse_keeper_romp_q0386_06.htm" : "warehouse_keeper_romp_q0386_07.htm";
    }
    ...
    public static class Bingo extends org.mmocore.gameserver.scripts.quests.Bingo {
        ...
        private final static String template_choice = "<a action=\"bypass -h npc_%objectId%_QuestEvent _386_StolenDignity choice-%n%\">%n%</a>&nbsp;&nbsp;&nbsp;&nbsp;  ";
