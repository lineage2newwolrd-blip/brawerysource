    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("quest_accept")) {
            ...
            if (GetMemoState == 1 && st.ownItemCount(q_blood_of_lizard_bottle) >= 500) {
                ...
                int i0 = Rnd.get(5);
                if (i0 == 0)
                    st.giveReward(rp_icarus_accipiter_i, 1, true);
                else if (i0 == 1)
                    st.giveReward(icarus_accipiter_piece, 1, true);
                else if (i0 == 2)
                    st.giveReward(icarus_accipiter_piece, 4, true);
                else if (i0 == 3)
                    st.giveReward(icarus_accipiter_piece, 4, true);
                else
                    st.giveReward(icarus_accipiter_piece, 6, true);
            ...
            if (GetMemoState == 1 && st.ownItemCount(q_blood_of_lizard_bottle) >= 100) {
                ...
                int i0 = Rnd.get(10);
                if (i0 == 0)
                    st.giveReward(rp_sealed_destino_leather_helmet_i, 1, true);
                else if (i0 == 1)
                    st.giveReward(rp_sealed_destino_houberk_i, 1, true);
                else if (i0 == 2)
                    st.giveReward(rp_sealed_destino_leather_legging_i, 1, true);
                else if (i0 == 3) {
                    int i1 = Rnd.get(2);
                    if (i1 == 0)
                        st.giveReward(rp_sealed_destino_leather_gloves_i, 1, true);
                    else
                        st.giveReward(rp_sealed_destino_leather_boots_i, 1, true);
                } else if (i0 == 4) {
                    int i1 = Rnd.get(10);
                    if (i1 < 4)
                    ...
                    st.giveReward(sealed_destino_leather_helmet_piece, 5, true);
                else if (i0 == 6)
                    st.giveReward(sealed_destino_houberk_piece, 5, true);
                else if (i0 == 7)
                    st.giveReward(sealed_destino_leather_legging_piece, 5, true);
                else if (i0 == 8) {
                    int i1 = Rnd.get(2);
                    if (i1 == 0)
                        st.giveReward(sealed_destino_leather_gloves_piece, 5, true);
                    else
                        st.giveReward(sealed_destino_leather_boots_piece, 5, true);
                } else {
                    int i1 = Rnd.get(10);
                    if (i1 < 4)
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (GetMemoState == 1)
            if (npcId == tantaar_lizardman_scout) {
                int i0 = Rnd.get(1000);
                if (i0 < 509) {
                    st.giveItems(q_blood_of_lizard_bottle, 1, true);
