...
public class warrior_ag_casting_enchant_physical_poison extends warrior_casting_enchant_physical_poison
{
	public warrior_ag_casting_enchant_physical_poison(final NpcInstance actor){super(actor);}
