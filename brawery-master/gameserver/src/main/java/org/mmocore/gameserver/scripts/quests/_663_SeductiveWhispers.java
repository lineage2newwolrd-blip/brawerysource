        ...
        if (npcId == blacksmith_wilbert) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (talker_param1 == i2) {
                    ...
                    if (i3 % 5 == 0 && i3 != 10) {
                        if (GetMemoState % 100 / 10 >= 7) {
                            ...
                            st.giveReward(ADENA_ID, 2384000, true);
                ...
                if (i0 == 0)
                    ...
                    st.giveReward(ADENA_ID, 110000, true);
                    st.giveItems(scrl_of_ench_wp_d, 1);
                } else if (i0 == 3) {
                    st.giveReward(ADENA_ID, 199000, true);
                    st.giveItems(scrl_of_ench_wp_c, 1);
                } else if (i0 == 4) {
                    st.giveReward(ADENA_ID, 388000, true);
                    i1 = Rnd.get(18) + 1;
                    if (i1 == 1)
                    ...
                    st.giveReward(ADENA_ID, 675000, true);
                    i1 = Rnd.get(18) + 1;
                    if (i1 == 1)
                    ...
                    st.giveReward(ADENA_ID, 1284000, true);
                ...
                if (talker_param1 == i2) {
                    ...
                    if (i3 % 5 == 0 && i3 != 10) {
                        ...
                        st.setMemoState("whispers_of_temptation", String.valueOf(1), true);
                        st.setMemoState("whispers_of_temptation_ex", String.valueOf(0), true);
                        st.giveReward(ADENA_ID, 800, true);
                    } else {
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == doom_knight) {
            if (GetMemoState >= 1 && GetMemoState <= 4) {
                int i0 = Rnd.get(1000);
                if (i0 < 807) {
                    st.giveItems(q_orb_of_spirit, 1, true);
            ...
            if (GetMemoState >= 1 && GetMemoState <= 4) {
                int i0 = Rnd.get(1000);
                if (i0 < 100) {
                    st.giveItems(q_orb_of_spirit, 2, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else {
                    st.giveItems(q_orb_of_spirit, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
