...
public class wizard_ag_casting_clanbuff_rangecurse_stone extends wizard_casting_clanbuff_rangecurse_stone
{
	public int MeleeAttackerAg = -1;

	public wizard_ag_casting_clanbuff_rangecurse_stone(final NpcInstance actor){super(actor);}
