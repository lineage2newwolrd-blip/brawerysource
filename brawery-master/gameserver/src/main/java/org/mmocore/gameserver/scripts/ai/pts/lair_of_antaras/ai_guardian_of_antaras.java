        ...
        ThreadPoolManager.getInstance().schedule(() -> {
            ...
            switch (i_ai0) {
                case 0:
                    ...
                    for (int i = 0; i < 4; i++) {
                        sendScriptEvent(ScriptEvent.SCE_WATCHER_DEAD1, getActor().getLeader() == null ? 0 : getActor().getLeader().getObjectId(), i, null);
                    }
                    actor.deleteMe();
                    break;
                case 1:
    ...
    private void nodeArrived() {
        if (i_ai2 < 1) {
            if (getSuperPoint() != null) {
                ...
                sendScriptEvent(ScriptEvent.SCE_WATCHER_DEAD1, getActor().getLeader() == null ? 0 : getActor().getLeader().getObjectId(), i_ai0, null);
                getActor().deleteMe();
            }
        }
    }
