        ...
        if (npcId == dorothy_the_locksmith) {
            ...
            if (event.equalsIgnoreCase("reply_4"))
                ...
                if (st.ownItemCount(q0345_bone_useless) > 0) {
                    st.giveReward(ADENA_ID, st.ownItemCount(q0345_bone_useless) * 104, true);
            ...
            case STARTED:
                if (npcId == dorothy_the_locksmith) {
                    if (GetMemoState == 0) {
                        ...
                        st.giveReward(ADENA_ID, 5390 + 70 * st.ownItemCount(q0345_bone_useless), true);
                        st.takeItems(q0345_bone_useless, -1);
                        ...
                        st.giveReward(ADENA_ID, 3040 + 70 * st.ownItemCount(q0345_bone_useless), true);
                        st.takeItems(q0345_bone_useless, -1);
                        st.removeMemo("how_to_face_the_dead");
                        st.removeMemo("how_to_face_the_dead_ex");
                        st.soundEffect(SOUND_FINISH);
            ...
            if (npcId == crokian || npcId == crokian_warrior) {
                ...
                if (i0 <= 5) {
                    if (st.ownItemCount(q0345_bone_arm) == 0)
                        ...
                        st.giveItems(q0345_bone_useless, 1, true);
