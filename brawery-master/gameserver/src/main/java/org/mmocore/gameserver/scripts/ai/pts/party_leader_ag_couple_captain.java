...
public class party_leader_ag_couple_captain extends party_leader_couple_captain
{
	public party_leader_ag_couple_captain(final NpcInstance actor){super(actor);}
