...
public class ritual_immolation_one extends warrior_pa_heretic_corpse_zombie_physicalspecial
{
	public ritual_immolation_one(final NpcInstance actor){super(actor);}
