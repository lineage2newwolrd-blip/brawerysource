...
public class party_leader_ag_wizard_fiend_archer extends party_leader_wizard_fiend_archer
{
	public party_leader_ag_wizard_fiend_archer(final NpcInstance actor){super(actor);}
