...
public class _300_HuntingLetoLizardman extends Quest {
            ...
            if (st.ownItemCount(BRACELET_OF_LIZARDMAN) < 60) {
                ...
                switch (Rnd.get(3)) {
                    case 0:
                        ...
                        break;
                    case 1:
                        st.giveReward(ANIMAL_BONE, 50, true);
                        break;
                    case 2:
                        st.giveReward(ANIMAL_SKIN, 50, true);
                        break;
                }
    ...
    public String onKill(NpcInstance npc, QuestState qs) {
        ...
        if (_count < 60 && Rnd.chance(BRACELET_OF_LIZARDMAN_CHANCE)) {
            qs.giveItems(BRACELET_OF_LIZARDMAN, 1, true);
            if (qs.ownItemCount(BRACELET_OF_LIZARDMAN) >= 60) {
                qs.setCond(2);
