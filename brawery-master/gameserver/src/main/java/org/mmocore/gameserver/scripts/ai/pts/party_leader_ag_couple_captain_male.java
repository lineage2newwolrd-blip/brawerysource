...
public class party_leader_ag_couple_captain_male extends party_leader_couple_captain_male
{
	public party_leader_ag_couple_captain_male(final NpcInstance actor){super(actor);}
