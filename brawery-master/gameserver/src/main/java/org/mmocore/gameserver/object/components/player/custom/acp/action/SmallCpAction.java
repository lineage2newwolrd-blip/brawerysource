...
public class SmallCpAction extends AbstractAction {
    ...
    public void useAction() {
        ...
        if (itemInstance != null) {
            if (getPlayer().getCurrentCpPercents() > getTemplate().getSmallCpPercent()) {
                //().sendMessage(new CustomMessage("component.acp.maxValue").addString("Small CP").toString(getPlayer()));
