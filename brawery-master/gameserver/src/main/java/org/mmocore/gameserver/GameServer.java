...
import org.mmocore.gameserver.network.xmlrpc.handler.PlayerHandler;
...
public class GameServer {
    ...
    private final long _serverStarted;
    ...
    {
        return ServerConfig.EXTERNAL_HOSTNAME.getBytes();
    }
    ...
    public int uptime() {
        return (int)(System.currentTimeMillis() - _serverStarted)/1000;
    }

    public int uptimeInMillis() {
        return (int)(System.currentTimeMillis() - _serverStarted);
    }
