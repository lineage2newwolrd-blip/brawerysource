...
public class soothsayers_aide extends party_private_casting_ddmagic_curse_stone
{
	public soothsayers_aide(final NpcInstance actor){super(actor);}
	...
	protected void onEvtAttacked(Creature attacker, int skill_name_id, int skill_id, int damage)
	{
		...
		if (AiUtils.HaveMemo(attacker, 615)!=0 && AiUtils.GetMemoState(attacker, 615) == 2)
		{
			...
			{
				AddUseSkillDesire(attacker, 297992193/*@skill_4547_1*/, DesireType.ATTACK, DesireMove.MOVE_TO_TARGET, 1000000);
			}
		}
