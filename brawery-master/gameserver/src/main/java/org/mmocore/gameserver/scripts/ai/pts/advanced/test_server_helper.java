package org.mmocore.gameserver.scripts.ai.pts.advanced;
            ...
            if (player.getPlayerClassComponent().getClassId().isOfLevel(ClassLevel.Third) && player.getLevel() > 75) {
                switch (player.getPlayerClassComponent().getClassId()) {
                    ...
                    case bishop: {
                        ...
                        player.getQuestState(255).giveReward(potion_of_experience_bishop, 1, false);
                        player.getQuestState(255).soundEffect("ItemSound.quest_fanfare_2");
                        actor.showChatWindow(player, fnAfterClassChange);
                        break;
                    }
                    ...
                    case elder: {
                        ...
                        player.getQuestState(255).giveReward(potion_of_experience_elder, 1, false);
                        player.getQuestState(255).soundEffect("ItemSound.quest_fanfare_2");
                        actor.showChatWindow(player, fnAfterClassChange);
                        break;
                    }
                    ...
                    case shillien_elder: {
                        ...
                        player.getQuestState(255).giveReward(potion_of_experience_silien_elder, 4, false);
                        player.getQuestState(255).soundEffect("ItemSound.quest_fanfare_2");
                        actor.showChatWindow(player, fnAfterClassChange);
                        break;
                    }
