...
{
	public marsh_stakato_drone(final NpcInstance actor){super(actor);}
	...
	protected void onEvtDead(Creature attacker)
	{
		...
		target = attacker;
		if (AiUtils.HaveMemo(target, 64) == 1 && AiUtils.GetMemoState(target, 64) == 7 && AiUtils.OwnItemCount(target, 9757) == 0)
		{
			...
			switch (code_info.getCode())
			{
				...
				case 3:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						...
						if (AiUtils.HaveMemo(c1, 220)!=0 && AiUtils.OwnItemCount(c1, 3209)!=0 && AiUtils.OwnItemCount(c1, 3210)!=0 && AiUtils.OwnItemCount(c1, 3213) == 0 && AiUtils.OwnItemCount(c1, 3233)!=0 && AiUtils.OwnItemCount(c1, 3234) < 30)
						{
							if (AiUtils.Rand(20) < 20)
							{
								if (AiUtils.OwnItemCount(c1, 3234) == 29)
								{
									GiveItem1(c1, 3234, 1);
									SoundEffect(c1, "Itemsound.quest_middle");
								}
				...
				case 6:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						...
						if (AiUtils.HaveMemo(c1, 213)!=0 && AiUtils.OwnItemCount(c1, 2667) == 1 && AiUtils.OwnItemCount(c1, 2668) == 0)
						{
							if (AiUtils.Rand(100) < 100)
							{
								c1.quest_last_reward_time = GetCurrentTick();
								GiveItem1(c1, 2668, 1);
								SoundEffect(c1, "ItemSound.quest_middle");
								if (AiUtils.OwnItemCount(c1, 2669) >= 1 && AiUtils.OwnItemCount(c1, 2670) >= 1 && AiUtils.OwnItemCount(c1, 2671) >= 1)
								{
				...
				case 7:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						...
						if (AiUtils.HaveMemo(c1, 222)!=0 && AiUtils.OwnItemCount(c1, 2764) > 0 && AiUtils.OwnItemCount(c1, 2770) < 10 && AiUtils.GetMemoState(c1, 222) == 1)
						{
							i0 = AiUtils.GetMemoStateEx(c1, 222, 1);
							SetMemoStateEx(c1, 222, 1, i0 + 1);
							c1.quest_last_reward_time = GetCurrentTick();
							GiveItem1(c1, 2770, 1);
							if (AiUtils.OwnItemCount(c1, 2770) >= 10)
							{
								SoundEffect(c1, "ItemSound.quest_middle");
								if (i0 >= 9)
								{
				...
				case 9:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						...
						if (i0 < 20)
						{
							GiveItem1(target, 9757, 1);
							if (AiUtils.OwnItemCount(target, 9756) > 0)
							{
