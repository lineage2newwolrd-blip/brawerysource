...
public class warrior_ag_physicalspecial_spoil extends warrior_physicalspecial_spoil
{
	public warrior_ag_physicalspecial_spoil(final NpcInstance actor){super(actor);}
