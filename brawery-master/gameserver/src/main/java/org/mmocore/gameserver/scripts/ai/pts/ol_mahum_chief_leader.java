...
public class ol_mahum_chief_leader extends warrior_aggressive_run_away_to_clan
{
	public ol_mahum_chief_leader(final NpcInstance actor){super(actor);}
			...
			switch (code_info.getCode())
			{
				case 0:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						...
						if (AiUtils.HaveMemo(c1, 213)!=0 && AiUtils.OwnItemCount(c1, 2649) == 1 && AiUtils.OwnItemCount(c1, 2654) == 0)
						{
							if (AiUtils.Rand(100) < 100)
							{
								...
								if (AiUtils.OwnItemCount(c1, 2655) >= 1 && AiUtils.OwnItemCount(c1, 2656) >= 1 && AiUtils.OwnItemCount(c1, 2657) >= 1)
								{
