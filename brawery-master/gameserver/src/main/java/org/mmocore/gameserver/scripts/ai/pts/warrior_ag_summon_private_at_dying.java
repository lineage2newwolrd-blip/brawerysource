...
public class warrior_ag_summon_private_at_dying extends warrior_summon_private_at_dying
{
	public warrior_ag_summon_private_at_dying(final NpcInstance actor){super(actor);}
