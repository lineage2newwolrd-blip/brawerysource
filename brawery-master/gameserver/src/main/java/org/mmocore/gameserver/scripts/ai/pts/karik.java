...
public class karik extends warrior_ag_casting_3skill_approach
{
	public karik(final NpcInstance actor){super(actor);}
				...
				if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
				{
					...
					if (i1 != 0)
					{
						for (i0 = 0; i0 < i1; i0++)
						{
							...
							if (i2 > i3 && AiUtils.HaveMemo(c1, 375)!=0)
							{
								i3 = i2;
								c2 = c1;
							}
					...
					if (AiUtils.HaveMemo(c2, 375)!=0 && !IsNullCreature(c2) && DistFromMe(c2) <= 1500)
					{
						c2.quest_last_reward_time = GetCurrentTick();
						if (AiUtils.Rand(100) < 25 && AiUtils.OwnItemCount(c2, 5888) < 100)
						{
							if (AiUtils.OwnItemCount(c2, 5888) == 99)
							{
								GiveItem1(c2, 5888, 1);
						...
						else if (AiUtils.OwnItemCount(c2, 5888) < 100)
						{
							if (AiUtils.OwnItemCount(c2, 5888) == 99)
							{
								GiveItem1(c2, 5888, 1);
