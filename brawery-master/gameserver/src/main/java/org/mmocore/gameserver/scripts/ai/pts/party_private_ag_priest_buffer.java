...
public class party_private_ag_priest_buffer extends party_private_priest_buffer
{
	public party_private_ag_priest_buffer(final NpcInstance actor){super(actor);}
