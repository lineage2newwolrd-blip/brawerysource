...
public class kranrot extends warrior_aggressive_physicalspecial
{
	public kranrot(final NpcInstance actor){super(actor);}
	...
	protected void onEvtDead(Creature attacker)
	{
		...
		target = attacker;
		if (((AiUtils.GetMemoState(target, 337) == 21101 || AiUtils.GetMemoState(target, 337) == 21100 || AiUtils.GetMemoState(target, 337) == 21001 || AiUtils.GetMemoState(target, 337) == 21000 || AiUtils.GetMemoState(target, 337) == 20101 || AiUtils.GetMemoState(target, 337) == 20100 || AiUtils.GetMemoState(target, 337) == 20001 || AiUtils.GetMemoState(target, 337) == 20000) && AiUtils.OwnItemCount(target, 3855) == 0) && AiUtils.HaveMemo(target, 337) == 1)
		{
