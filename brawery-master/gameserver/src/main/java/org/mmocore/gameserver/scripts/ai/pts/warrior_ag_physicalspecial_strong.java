...
public class warrior_ag_physicalspecial_strong extends warrior_physicalspecial_strong
{
	public warrior_ag_physicalspecial_strong(final NpcInstance actor){super(actor);}
