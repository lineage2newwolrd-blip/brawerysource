...
public class warrior_ag_physicalspecial_area extends warrior_physicalspecial_area
{
	public warrior_ag_physicalspecial_area(final NpcInstance actor){super(actor);}
