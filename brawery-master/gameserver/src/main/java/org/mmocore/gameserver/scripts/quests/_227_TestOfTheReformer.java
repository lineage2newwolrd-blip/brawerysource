...
public class _227_TestOfTheReformer extends Quest {
    ...
    public _227_TestOfTheReformer() {
        ...
        addLevelCheck(39);
        addClassIdCheck(ClassId.cleric, ClassId.shillien_oracle);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("30118-04.htm")) {
            ...
            if (GameObjectsStorage.getByNpcId(CrimsonWerewolf) == null) {
                ...
                st.startQuestTimer("Wait4", 300000, npc);
            } else {
            ...
            if (GameObjectsStorage.getByNpcId(KrudelLizardman) == null) {
                ...
                st.startQuestTimer("Wait5", 300000, npc);
            } else {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        int cond = st.getCond();
        if (npcId == Pupina) {
            if (st.ownItemCount(MarkOfReformer) != 0) {
                htmltext = "completed";
                st.exitQuest(true);
            } else if (cond == 0) {
            ...
            if (cond == 4) {
                ...
                if (!st.getPlayer().getPlayerVariables().getBoolean(PlayerVariables.PROF2_3)) {
                    ...
                    st.giveReward(ADENA_ID, 226528, true);
            ...
            if (cond == 5 || cond == 6) {
                ...
                if (NPC == null && Mob == null) {
                    ...
                    st.startQuestTimer("Wait2", 300000, npc);
                } else {
                ...
                if (GameObjectsStorage.getByNpcId(OlMahumBetrayer) == null) {
                    ...
                    st.startQuestTimer("Wait3", 300000, npc);
                } else {
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (cond == 18 && st.ownItemCount(BoneFragment1) != 0 && st.ownItemCount(BoneFragment2) != 0 && st.ownItemCount(BoneFragment3) != 0 && st.ownItemCount(BoneFragment4) != 0 && st.ownItemCount(BoneFragment5) != 0) {
            st.setCond(19);
            st.setState(STARTED);
        } else if (npcId == NamelessRevenant && (cond == 1 || cond == 2)) {
            if (st.ownItemCount(RippedDiary) < 6) {
                ...
                st.startQuestTimer("Wait1", 300000, npc);
            ...
            if (cond == 8) {
                if (st.ownItemCount(LetterOfBetrayer) == 0) {
