...
public class NpcUtils {
    ...
    public static NpcInstance altPassPacket(Player player, L2GameClientPacket packet, Object... arg)
    {
        final NpcInstance npcInstance = player.getLastNpc();
        return (npcInstance != null && player.isInRangeZ(npcInstance.getLoc(), npcInstance.getInteractDistance(player)) && npcInstance.altPassPacket(player, packet.getClass(), arg)) ? npcInstance : null;
    }
    ...
    public static NpcInstance spawnSingle(final int npcId, final Location loc, final Reflection reflection, final long despawnTime, final String title) {
        ...
        npc.setHeading(loc.h < 0 ? 65535 - (loc.h % 65535) : loc.h);
