...
public class warrior_ag_berserker_physicalspecial_stone extends warrior_berserker_physicalspecial_stone
{
	public int MeleeAttackerAg = -1;

	public warrior_ag_berserker_physicalspecial_stone(final NpcInstance actor){super(actor);}
