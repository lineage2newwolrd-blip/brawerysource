...
{
	public crimsha_werewolf(final NpcInstance actor){super(actor);}
	...
	protected void onEvtDead(Creature attacker)
	{
		...
		while (!AiUtils.IsNull(code_info = always_list.Next()))
		{
			if (code_info.getCode() == 0)
			{
				...
				{
					if (AiUtils.HaveMemo(c_quest0, 227) == 1 && AiUtils.GetMemoState(c_quest0, 227) == 11)
					{
						SetMemoState(c_quest0, 227, 12);
						SetFlagJournal(c1, 227, 13);
