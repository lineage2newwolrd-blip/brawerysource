...
public class _357_WarehouseKeepersAmbition extends Quest {
        ...
        if (npcId == warehouse_keeper_silva) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (st.ownItemCount(jade_crystal) < 100 && st.ownItemCount(jade_crystal) > 0) {
                    st.giveReward(ADENA_ID, st.ownItemCount(jade_crystal) * 425 + 13500, true);
                    st.takeItems(jade_crystal, -1);
                    htmltext = "warehouse_keeper_silva_q0357_08.htm";
                } else if (st.ownItemCount(jade_crystal) >= 100) {
                    st.giveReward(ADENA_ID, st.ownItemCount(jade_crystal) * 425 + 40500, true);
                    st.takeItems(jade_crystal, -1);
                ...
                if (st.ownItemCount(jade_crystal) < 100 && st.ownItemCount(jade_crystal) > 0) {
                    st.giveReward(ADENA_ID, st.ownItemCount(jade_crystal) * 425, true);
                } else if (st.ownItemCount(jade_crystal) >= 100) {
                    st.giveReward(ADENA_ID, st.ownItemCount(jade_crystal) * 425 + 40500, true);
                }
                st.takeItems(jade_crystal, -1);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == forest_runner) {
            if (Rnd.get(1000) < 577) {
                st.giveItems(jade_crystal, 1, true);
            ...
            if (Rnd.get(1000) < 62) {
                st.giveItems(jade_crystal, 2, true);
                st.soundEffect(SOUND_ITEMGET);
            } else {
                st.giveItems(jade_crystal, 1, true);
                st.soundEffect(SOUND_ITEMGET);
