    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (npcId == wharf_soldier_plenos) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (GetMemoState == 2 && st.ownItemCount(q_drake_flesh) >= 1) {
                    st.giveReward(ADENA_ID, st.ownItemCount(q_drake_flesh) * 100, true);
                ...
                if (GetMemoState == 2 && st.ownItemCount(q_horn_of_m_drake_wing) < 1)
                    ...
                    st.giveReward(ADENA_ID, st.ownItemCount(q_horn_of_m_drake_wing) * 200000, true);
            ...
            if (event.equalsIgnoreCase("reply_1")) {
                ...
                if (GetMemoState == 2 && st.ownItemCount(q_horn_of_m_drake_wing) >= 1) {
                    ...
                    int i1 = Rnd.get(1000);
                    if (i0 >= 500 && i1 >= 600) {
                        st.giveReward(ADENA_ID, Rnd.get(49917) + 125000, true);
                        if (i1 < 720) {
                        ...
                        st.giveReward(ADENA_ID, Rnd.get(49917) + 25000, true);
                        if (i1 < 720) {
                            st.giveItems(renad, Rnd.get(3) + 1);
                            st.giveItems(adamantium, Rnd.get(3) + 1);
                        } else if (i1 < 840) {
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (GetMemoState == 2)
            if (npcId == drake_wing_knave_1lv || npcId == drake_wing_knave_3lv) {
                int i0 = Rnd.get(1000);
                if (i0 < 485)
                    st.giveItems(q_drake_flesh, 2, true);
                else
                    st.giveItems(q_drake_flesh, 1, true);
