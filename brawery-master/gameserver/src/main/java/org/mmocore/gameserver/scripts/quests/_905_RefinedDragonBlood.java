    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == dragon_knight_3 || npcId == dragon_knight_5 || npcId == dragon_knight_9 || npcId == dragon_warrior || npcId == dragon_guard || npcId == dragon_mage) {
            if (GetMemoState == 1) {
                int i0 = Rnd.get(100);
                if (i0 < 30) {
                    st.giveItems(g_blue_blood_of_dragon1, 1, true);
                    if (st.ownItemCount(g_red_blood_of_dragon1) >= 10 && st.ownItemCount(g_blue_blood_of_dragon1) >= 10) {
                        st.setCond(2);
            ...
            if (GetMemoState == 1) {
                int i0 = Rnd.get(100);
                if (i0 < 30) {
                    st.giveItems(g_red_blood_of_dragon1, 1, true);
                    if (st.ownItemCount(g_red_blood_of_dragon1) >= 10 && st.ownItemCount(g_blue_blood_of_dragon1) >= 10) {
                        st.setCond(2);
                        st.soundEffect(SOUND_MIDDLE);
                    } else {
