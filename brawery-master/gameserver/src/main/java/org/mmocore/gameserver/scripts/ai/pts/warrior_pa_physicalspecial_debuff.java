...
public class warrior_pa_physicalspecial_debuff extends warrior_physicalspecial_debuff
{
	public warrior_pa_physicalspecial_debuff(final NpcInstance actor){super(actor);}
