        ...
        if (npcId == sophia) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (st.ownItemCount(black_lion_mark) >= 1) {
                    st.giveReward(ADENA_ID, 12400, true);
            ...
            if (event.equalsIgnoreCase("menu_select?ask=333&reply=1")) {
                if (st.ownItemCount(q_loot_18) >= 1) {
                    st.giveReward(ADENA_ID, 30000, true);
                ...
                if (npcId == sophia) {
                    if (st.ownItemCount(q_sophias_order1) + st.ownItemCount(q_sophias_order2) + st.ownItemCount(q_sophias_order3) + st.ownItemCount(q_sophias_order4) == 0)
                        ...
                        if (i0 < 20) {
                            ...
                            st.giveItems(q_lions_claw, 3);
                        st.giveReward(ADENA_ID, st.ownItemCount(q_undead_ash) * 35, true);
                        st.giveReward(ADENA_ID, st.ownItemCount(q_bloodyaxe_insignia) * 35, true);
                        st.giveReward(ADENA_ID, st.ownItemCount(q_delu_lizardman_fang) * 35, true);
                        st.giveReward(ADENA_ID, st.ownItemCount(q_stakato_talon) * 35, true);
                        st.takeItems(q_undead_ash, -1);
                        st.takeItems(q_bloodyaxe_insignia, -1);
                        st.takeItems(q_delu_lizardman_fang, -1);
                        st.takeItems(q_stakato_talon, -1);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == marsh_stakato) {
            if (st.ownItemCount(q_sophias_order4) >= 1) {
                if (Rnd.get(100) < 55) {
                    st.giveItems(q_stakato_talon, 1, true);
            ...
            if (st.ownItemCount(q_sophias_order1) >= 1) {
                if (Rnd.get(2) == 0) {
                    st.giveItems(q_undead_ash, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                }
                if (Rnd.get(100) < 11) {
            ...
            if (st.ownItemCount(q_sophias_order2) >= 1) {
                if (Rnd.get(2) == 0) {
                    st.giveItems(q_bloodyaxe_insignia, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                }
                if (Rnd.get(100) < 9) {
            ...
            if (st.ownItemCount(q_sophias_order3) >= 1) {
                if (Rnd.get(2) == 0) {
                    st.giveItems(q_delu_lizardman_fang, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                }
                if (Rnd.get(100) < 14) {
            ...
            if (st.ownItemCount(q_sophias_order3) >= 1) {
                st.giveItems(q_delu_lizardman_fang, 4, true);
                st.soundEffect(SOUND_ITEMGET);
            }
