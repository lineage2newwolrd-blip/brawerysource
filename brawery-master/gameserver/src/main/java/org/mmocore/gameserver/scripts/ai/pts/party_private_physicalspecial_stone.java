...
public class party_private_physicalspecial_stone extends party_private_physical
{
	public int DeBuff1 = 295895041;

	public party_private_physicalspecial_stone(final NpcInstance actor){super(actor);}
