...
public class party_private_ag_physicalspecial_stone extends party_private_physicalspecial_stone
{
	public int MeleeAttackerAg = -1;

	public party_private_ag_physicalspecial_stone(final NpcInstance actor){super(actor);}
