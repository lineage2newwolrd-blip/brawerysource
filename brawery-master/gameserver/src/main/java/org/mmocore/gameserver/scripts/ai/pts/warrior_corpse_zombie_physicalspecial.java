...
public class warrior_corpse_zombie_physicalspecial extends warrior_corpse_zombie_basic
{
	public int PhysicalSpecial = 264241153;

	public warrior_corpse_zombie_physicalspecial(final NpcInstance actor){super(actor);}
