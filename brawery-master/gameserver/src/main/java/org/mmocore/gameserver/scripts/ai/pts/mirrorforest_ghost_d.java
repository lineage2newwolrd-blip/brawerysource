...
public class mirrorforest_ghost_d extends warrior_aggressive
{
	public mirrorforest_ghost_d(final NpcInstance actor){super(actor);}
			...
			switch (code_info.getCode())
			{
				...
				case 1:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						...
						if (AiUtils.OwnItemCount(target, 9787) < 35)
						{
							...
							if (i4 < 90 && AiUtils.OwnItemCount(target, 9787) < 34)
							{
								GiveItem1(target, 9787, 1);
							}
						}
