...
public class AiConfig {
    ...
    @Setting(name = "UseTeleportSkill")
    public static boolean USE_TELEPORT_SKILL;

    @Setting(name = "MinPursueRange")
    public static int MIN_PURSUE_RANGE;

    @Setting(name = "MaxPursueDungeonRange")
    public static int MAX_PURSUE_RANGE_DUNGEON;

    @Setting(name = "MaxPursueSSQRange")
    public static int MAX_PURSUE_SSQ_RANGE;
