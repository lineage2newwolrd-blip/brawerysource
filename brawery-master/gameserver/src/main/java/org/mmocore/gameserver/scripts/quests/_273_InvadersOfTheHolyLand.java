                ...
                if (npcId == atuba_chief_varkees) {
                    if (st.ownItemCount(black_soulstone) + st.ownItemCount(red_soulstone) == 0)
                        ...
                        if (st.ownItemCount(black_soulstone) >= 10)
                            st.giveReward(ADENA_ID, st.ownItemCount(black_soulstone) * 3 + 1500, true);
                        else
                            st.giveReward(ADENA_ID, st.ownItemCount(black_soulstone) * 3, true);
                        ...
                        if (st.ownItemCount(black_soulstone) + st.ownItemCount(red_soulstone) >= 10)
                            st.giveReward(ADENA_ID, st.ownItemCount(red_soulstone) * 10 + st.ownItemCount(black_soulstone) * 3 + 1800, true);
                        else
                            st.giveReward(ADENA_ID, st.ownItemCount(red_soulstone) * 10 + st.ownItemCount(black_soulstone) * 3, true);
                        st.takeItems(black_soulstone, -1);
