...
public class AllSettingsConfig {
    ...
    @Setting(name = "AltShotCorrection")
    public static int ALT_SHOT_CORRECTION;
    ...
    @Setting(name = "AllowEventGatekeeper")
    ...
    @Setting(name = "SaveBuffHerb")
    public static boolean ALT_SAVE_BUFF_HERB;
    ...
    @Setting(name = "AltChampionMinLevel")
    ...
    public static boolean AltClosedDelusion;
    ...
    public static int clanDissolvePenalty;
