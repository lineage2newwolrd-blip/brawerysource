...
public enum Stats {
    ...
    POLE_TARGET_COUNT("poleTargetCount", 0, 20.),
    ...
    DEATH_VULNERABILITY("deathVuln", 0., 190., 100.),
    ...
    // минимум 0, максимум 200, дефольт 100, тут всё нормуль
    CRIT_DAMAGE_POSITION_FRONT("critPositionFront", 0, 200, 100), // увеличивает/снижает урон критом цели спереди
    CRIT_DAMAGE_POSITION_BACK("critPositionBack", 0, 200, 100), // увеличивает/снижает урон критом цели сзади
    CRIT_DAMAGE_POSITION_SIDE("critPositionSide", 0, 200, 100), // увеличивает/снижает урон критом цели сбоку

    // минимум 0, максимум 200, дефольт 100, тут всё нормуль
    CRIT_DAMAGE_POSITION_FRONT_CHANCE("critPositionChanceFront", 0, 200, 100), // увеличивает/снижает шанс нанести урон критом цели спереди
    CRIT_DAMAGE_POSITION_BACK_CHANCE("critPositionChanceBack", 0, 200, 100), // увеличивает/снижает шанс нанести урон критом цели сзади
    CRIT_DAMAGE_POSITION_SIDE_CHANCE("critPositionChanceSide", 0, 200, 100), // увеличивает/снижает шанс нанести урон критом цели сбоку
    ...
    DUALFIST_WPN_VULNERABILITY("dualFistWpnVuln", 10., 200., 100.),
    BIGSWORD_WPN_VULNERABILITY("bigSwordWpnVuln", 10., 200., 100.),
    BLUNT_WPN_VULNERABILITY("bluntWpnVuln", 10., 200., 100.),
    BIGBLUNT_WPN_VULNERABILITY("bigBluntWpnVuln", 10., 200., 100.),
    ...
    RAPIER_WPN_VULNERABILITY("rapierWpnVuln", 10., 200., 100.),
    POLE_WPN_VULNERABILITY("poleWpnVuln", 10., 200., 100.),
    FIST_WPN_VULNERABILITY("fistWpnVuln", 10., 200., 100.),
    ANCIENT_WPN_VULNERABILITY("ancientWpnVuln", 10., 200., 100.),
    DUALDAGGER_WPN_VULNERABILITY("dualDaggerWpnVuln", 10., 200., 100.),

    // минимум 0, максимум 200, дефольт 100, тут всё нормуль
    BUG_WEAKNESS_POWER("bugWeaknessPower", 0, 200, 100), // увеличивает дамаг определённой рассе НПЦ
    ANIMAL_WEAKNESS_POWER("animalWeaknessPower", 0, 200, 100), // увеличивает дамаг определённой рассе НПЦ
    PLANT_WEAKNESS_POWER("plantWeaknessPower", 0, 200, 100), // увеличивает дамаг определённой рассе НПЦ
    BEAST_WEAKNESS_POWER("beastWeaknessPower", 0, 200, 100), // увеличивает дамаг определённой рассе НПЦ
    DRAGON_WEAKNESS_POWER("dragonWeaknessPower", 0, 200, 100), // увеличивает дамаг определённой рассе НПЦ
    GIANT_WEAKNESS_POWER("giantWeaknessPower", 0, 200, 100), // увеличивает дамаг определённой рассе НПЦ
    CONSTRUST_WEAKNESS_POWER("construstWeaknessPower", 0, 200, 100), // увеличивает дамаг определённой рассе НПЦ

    // минимум -100, максимум 100, дефольт 0, тут всё нормуль
    BUG_WEAKNESS_RECEPTIVE("bugWeaknessRcpt", -100, 100, 0), // добавляет защиту определённой рассе НПЦ
    ANIMAL_WEAKNESS_RECEPTIVE("animalWeaknessRcpt", -100, 100, 0), // добавляет защиту определённой рассе НПЦ
    PLANT_WEAKNESS_RECEPTIVE("plantWeaknessRcpt", -100, 100, 0), // добавляет защиту определённой рассе НПЦ
    BEAST_WEAKNESS_RECEPTIVE("beastWeaknessRcpt", -100, 100, 0), // добавляет защиту определённой рассе НПЦ
    DRAGON_WEAKNESS_RECEPTIVE("dragonWeaknessRcpt", -100, 100, 0), // добавляет защиту определённой рассе НПЦ
    GIANT_WEAKNESS_RECEPTIVE("giantWeaknessRcpt", -100, 100, 0), // добавляет защиту определённой рассе НПЦ
    CONSTRUST_WEAKNESS_RECEPTIVE("construstWeaknessRcpt", -100, 100, 0), // добавляет защиту определённой рассе НПЦ
    ...
    MANAHEAL_EFFECTIVNESS("mpEff", -1000., 1000.),
    CPHEAL_EFFECTIVNESS("cpEff", 0., 1000.),
    HEAL_POWER("healPower", 0., 2000.),
