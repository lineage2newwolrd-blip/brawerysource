...
public class ai_stakato_refine_cannibal_leader extends party_leader_ag_cannibali
{
	public ai_stakato_refine_cannibal_leader(final NpcInstance actor){super(actor);}
