...
public class party_private_ag_couple_follower extends party_private_couple_follower
{
	public party_private_ag_couple_follower(final NpcInstance actor){super(actor);}
