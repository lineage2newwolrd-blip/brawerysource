        ...
        if (npcId == dark_necromancer) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (st.ownItemCount(q_gem_of_saints) >= 1) {
                    ...
                    st.giveReward(ADENA_ID, 6400, true);
                    st.soundEffect(SOUND_FINISH);
                    st.exitQuest(true);
                    htmltext = "dark_necromancer_q0627_0402.htm";
                } else
                ...
                if (st.ownItemCount(q_gem_of_saints) >= 1) {
                    ...
                    st.giveReward(ADENA_ID, 13600, true);
                    st.soundEffect(SOUND_FINISH);
                    st.exitQuest(true);
                    htmltext = "dark_necromancer_q0627_0402.htm";
                } else
                ...
                if (st.ownItemCount(q_gem_of_saints) >= 1) {
                    ...
                    st.giveReward(ADENA_ID, 17200, true);
                    st.soundEffect(SOUND_FINISH);
                    st.exitQuest(true);
                    htmltext = "dark_necromancer_q0627_0402.htm";
                } else
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == brilliant_eye) {
            if (GetMemoState == 1 * 10 + 1) {
                int i4 = Rnd.get(1000);
                if (i4 < 661) {
                    if (st.ownItemCount(q_gem_of_submission) + 1*st.getRateQuestsDrop() >= 300) {
                        if (st.ownItemCount(q_gem_of_submission) < 300) {
                            st.setCond(2);
                        ...
                        st.giveItems(q_gem_of_submission, 1, true);
