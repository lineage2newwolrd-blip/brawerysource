...
public class UnitMember {
    ...
    public UnitMember(final Clan clan, final String name, final String title, final int level, final int classId, final int objectId,
                      final int pledgeType, final int powerGrade, final int apprentice, final int sex, final int race, final int leaderOf) {
        _clan = clan;
        _objectId = objectId;
        _name = name;
        _title = title;
    ...
    public void setPlayerInstance(final Player player, final boolean exit) {
        ...
        _classId = player.getPlayerClassComponent().getClassId().getId();
    ...
    public int getClassId() {
        final Player player = getPlayer();
        return player == null ? _classId : player.getPlayerClassComponent().getClassId().getId();
    }
    ...
    public int getRace() {
        final Player player = getPlayer();
        return player == null ? _race : player.getPlayerTemplateComponent().getPlayerRace().ordinal();
    }
    ...
    public void setTitle(final String title) {
        if (!Util.checkIsAllowedTitle(title))
            return;
        final Player player = getPlayer();
        _title = title;
        if (player != null) {
