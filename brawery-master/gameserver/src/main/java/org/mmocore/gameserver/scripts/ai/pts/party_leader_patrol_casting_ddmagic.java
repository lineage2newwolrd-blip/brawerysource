...
public class party_leader_patrol_casting_ddmagic extends party_leader_casting_ddmagic
{
	String WayPoints;
	int WayPointDelays;

	public party_leader_patrol_casting_ddmagic(final NpcInstance actor){super(actor);}
