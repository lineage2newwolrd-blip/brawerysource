...
public class warrior_ag_casting_ddmagic_physicalspecial_buff extends warrior_casting_ddmagic_physicalspecial_buff
{
	public warrior_ag_casting_ddmagic_physicalspecial_buff(final NpcInstance actor){super(actor);}
