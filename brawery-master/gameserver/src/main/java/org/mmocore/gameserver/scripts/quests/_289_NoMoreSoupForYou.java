...
public class _289_NoMoreSoupForYou extends Quest {
        ...
        if (npcId == stan) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (GetMemoState == 1 && st.ownItemCount(q_full_barrel_of_xel) < 500)
                    ...
                    switch (i0) {
                        case 0: {
                            st.giveReward(rp_icarus_trident_i, 1, true);
                            break;
                        }
                        case 1: {
                            st.giveReward(icarus_trident_piece, 3, true);
                            break;
                        }
                        case 2: {
                            st.giveReward(icarus_trident_piece, 4, true);
                            break;
                        }
                        case 3: {
                            st.giveReward(icarus_trident_piece, 5, true);
                            break;
                        }
                        case 4: {
                            st.giveReward(icarus_trident_piece, 6, true);
                            break;
                        }
                    }
                ...
                if (GetMemoState == 1 && st.ownItemCount(q_full_barrel_of_xel) < 100)
                    ...
                    switch (i0) {
                        case 0: {
                            int i1 = Rnd.get(10);
                            if (i1 < 4)
                                st.giveReward(rp_sealed_destino_helmet_i, 1, true);
                            else if (i1 >= 4 && i1 < 7)
                                st.giveReward(rp_sealed_destino_cuirass_i, 1, true);
                            else
                                st.giveReward(rp_sealed_destino_gaiter_i, 1, true);
                            break;
                        }
                        case 1: {
                            st.giveReward(rp_sealed_destino_gauntlet_i, 1, true);
                            break;
                        }
                        case 2: {
                            st.giveReward(rp_sealed_destino_boots_i, 1, true);
                            break;
                        }
                        case 3: {
                            st.giveReward(rp_sealed_destino_shield_i, 1, true);
                            break;
                        }
                        case 4: {
                            int i1 = Rnd.get(10);
                            if (i1 < 4)
                                st.giveReward(rp_sealed_destino_ring_i, 1, true);
                            else if (i1 >= 4 && i1 < 8)
                                st.giveReward(rp_sealed_destino_earring_i, 1, true);
                            else
                                st.giveReward(rp_sealed_destino_necklace_i, 1, true);
                            break;
                        }
                        case 5: {
                            int i1 = Rnd.get(10);
                            if (i1 < 4)
                                st.giveReward(sealed_destino_helmet_piece, 3, true);
                            else if (i1 >= 4 && i1 < 7)
                                st.giveReward(sealed_destino_cuirass_piece, 3, true);
                            else
                                st.giveReward(sealed_destino_gaiter_piece, 3, true);
                            break;
                        }
                        case 6: {
                            st.giveReward(sealed_destino_gauntlet_piece, 3, true);
                            break;
                        }
                        case 7: {
                            st.giveReward(sealed_destino_boots_piece, 3, true);
                            break;
                        }
                        case 8: {
                            st.giveReward(sealed_destino_shield_piece, 3, true);
                            break;
                        }
                        case 9: {
                            int i1 = Rnd.get(10);
                            if (i1 < 4)
                                st.giveReward(sealed_destino_ring_gem, 3, true);
                            else if (i1 >= 4 && i1 < 8)
                                st.giveReward(sealed_destino_earring_gem, 3, true);
                            else
                                st.giveReward(sealed_destino_necklace_gem, 3, true);
                            break;
                        }
                    }
                    st.soundEffect(SOUND_MIDDLE);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == ol_cooker) {
            if (GetMemoState == 1) {
                if (Rnd.get(1000) < 853) {
                    st.giveItems(q_full_barrel_of_xel, 1, true);
            ...
            if (GetMemoState == 1) {
                if (Rnd.get(1000) < 599) {
                    st.giveItems(q_empty_barrel_of_xel, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                }
            }
