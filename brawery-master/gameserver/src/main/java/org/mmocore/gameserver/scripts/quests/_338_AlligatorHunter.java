...
public class _338_AlligatorHunter extends Quest {
            ...
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (st.ownItemCount(q0338_crocodile_leather) == 0)
                    ...
                    if (st.ownItemCount(q0338_crocodile_leather) >= 10)
                        st.giveReward(ADENA_ID, 3430 + st.ownItemCount(q0338_crocodile_leather) * 60, true);
                    else
                        st.giveReward(ADENA_ID, st.ownItemCount(q0338_crocodile_leather) * 60, true);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == crocodile) {
            if (GetMemoState == 1) {
                st.giveItems(q0338_crocodile_leather, 1, true);
