...
public abstract class ExReceiveOlympiad extends L2GameServerPacket {
    ...
    public static class MatchList extends ExReceiveOlympiad {
        ...
        public MatchList(AbstractCustomObservableEvent[] events) {
            super(0);
            arenaList = new ArrayList<>();
            for (AbstractCustomObservableEvent e : events)
                if (e != null)
                    arenaList.add(new ArenaInfo(e.getArenaId(), e.getStateId(), 0, e.getTeamName1(), e.getTeamName2()));
        }
