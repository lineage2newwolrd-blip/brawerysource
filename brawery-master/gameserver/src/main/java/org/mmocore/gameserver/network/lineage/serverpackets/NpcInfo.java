...
public class NpcInfo extends GameServerPacket {
    ...
    public NpcInfo(final NpcInstance cha, final Creature attacker) {
        ...
        enchantEffect = cha.getActiveWeaponEchant();
    ...
    public NpcInfo(final Player player) {
        ...
        rhand = 0;//player.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_RHAND);
        lhand = 0;//player.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_LHAND);
