                ...
                if (npcId == elder_spiron) {
                    if (st.ownItemCount(goblin_necklace) < 1 && st.ownItemCount(goblin_pendant) < 1 && st.ownItemCount(goblin_lord_pendant) < 1 && st.ownItemCount(suspicious_memo) == 0 && st.ownItemCount(suspicious_contract) == 0)
                        ...
                        if (st.ownItemCount(goblin_necklace) + st.ownItemCount(goblin_pendant) + st.ownItemCount(goblin_lord_pendant) >= 10)
                            st.giveReward(ADENA_ID, st.ownItemCount(goblin_necklace) * 12 + st.ownItemCount(goblin_pendant) * 36 + st.ownItemCount(goblin_lord_pendant) * 33 + 1000, true);
                        else
                            st.giveReward(ADENA_ID, st.ownItemCount(goblin_necklace) * 12 + st.ownItemCount(goblin_pendant) * 36 + st.ownItemCount(goblin_lord_pendant) * 33, true);
                        ...
                        st.giveReward(ADENA_ID, st.ownItemCount(suspicious_contract) * 120 + 1000, true);
                        st.takeItems(goblin_necklace, -1);
                        st.takeItems(goblin_pendant, -1);
                        st.takeItems(goblin_lord_pendant, -1);
                    ...
                    if (st.ownItemCount(suspicious_contract) == 0)
                        ...
                        st.giveReward(ADENA_ID, st.ownItemCount(suspicious_contract) * 120 + 500, true);
                        st.takeItems(suspicious_contract, -1);
        ...
        if (npcId == goblin_brigand || npcId == goblin_brigand_leader || npcId == goblin_brigand_sub_ldr || npcId == goblin_snooper || npcId == goblin_lord) {
            ...
            if (i0 > 5) {
                if(npcId == goblin_brigand_leader)
                    st.giveItems(goblin_pendant, 1, true);
                else if(npcId == goblin_lord)
                    st.giveItems(goblin_lord_pendant, 1, true);
                else
                    st.giveItems(goblin_necklace, 1, true);
