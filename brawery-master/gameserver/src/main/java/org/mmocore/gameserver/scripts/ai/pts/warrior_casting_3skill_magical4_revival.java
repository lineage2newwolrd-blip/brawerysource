...
public class warrior_casting_3skill_magical4_revival extends warrior_casting_3skill_magical4
{
	public int silhouette = 1020130;
	public String ai_type = "warrior";

	public warrior_casting_3skill_magical4_revival(final NpcInstance actor){super(actor);}
