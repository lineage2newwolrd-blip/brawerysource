...
public class party_leader_casting_ddmagic_stone extends party_leader_casting_ddmagic
{
	public int DeBuff1 = 295895041;

	public party_leader_casting_ddmagic_stone(final NpcInstance actor){super(actor);}
