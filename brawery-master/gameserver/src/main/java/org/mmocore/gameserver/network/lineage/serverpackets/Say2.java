...
public class Say2 extends NpcStringContainer {
    ...
    public Say2(final int objectId, final ChatType type, final String charName, final int npcStringId, final String... params) {
        super(npcStringId, params);
        this.objectId = objectId;
        this.type = type;
        this.charName = charName;
    }
    ...
    public L2GameServerPacket packet(final Player player) {
        ...
        return new Say2(objectId, type, charName, npcStringId, text);
    }
}