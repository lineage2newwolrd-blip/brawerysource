...
import org.mmocore.gameserver.network.lineage.clientpackets.*;
import org.mmocore.gameserver.network.lineage.clientpackets.GoodsInventory.RequestGoodsInventoryInfo;
import org.mmocore.gameserver.network.lineage.clientpackets.GoodsInventory.RequestUseGoodsInventoryItem;
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.AttributStone.RequestEnchantItemAttribute;
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.AttributStone.RequestExRemoveItemAttribute;
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.EnchantScroll.RequestEnchantItem;
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.EnchantScroll.RequestExCancelEnchantItem;
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.EnchantScroll.RequestExTryToPutEnchantSupportItem;
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.EnchantScroll.RequestExTryToPutEnchantTargetItem;
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.RefineStone.RequestConfirmGemStone;
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.RefineStone.RequestConfirmRefinerItem;
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.RefineStone.RequestConfirmTargetItem;
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.RefineStone.RequestRefine;
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.RefineStone.RequestRefineCancel;
import org.mmocore.gameserver.network.lineage.clientpackets.Moving.*;
import org.mmocore.gameserver.network.lineage.clientpackets.PremiumShop.RequestExBR_BuyProduct;
import org.mmocore.gameserver.network.lineage.clientpackets.PremiumShop.RequestExBR_GamePoint;
import org.mmocore.gameserver.network.lineage.clientpackets.PremiumShop.RequestExBR_ProductInfo;
import org.mmocore.gameserver.network.lineage.clientpackets.PremiumShop.RequestExBR_ProductList;
import org.mmocore.gameserver.network.lineage.clientpackets.PremiumShop.RequestExBR_RecentProductList;
            ...
            case IN_GAME:
                switch (id) {
                    ...
                    case 0x09:
                        ...
                        break;
                    case 0x0a: // TODO[K] - резерв под протект, обратный пакет по блокировке коннекта!
                        //	msg = new RequestConnectBan();
                        break;
                    case 0x0b:
                    ...
                    case 0x3a:
                        ...
                        break;
                    case 0x3b:
                        if (ServerConfig.ALLOW_WAREHOUSE) {
