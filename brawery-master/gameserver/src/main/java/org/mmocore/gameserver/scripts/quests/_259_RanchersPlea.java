...
public class _259_RanchersPlea extends Quest {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == 30497 && st.getCond() == 0) {
            ...
            st.giveReward(ADENA_ID, st.ownItemCount(GIANT_SPIDER_SKIN_ID) * 25, true);
