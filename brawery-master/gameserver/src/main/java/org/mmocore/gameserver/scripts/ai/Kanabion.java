...
public class Kanabion extends Fighter {
    ...
    public static class SpawnNext extends RunnableImpl {
        ...
        public void runImpl() throws Exception {
            ...
            if(_player == null || _player.getReflection() != _actor.getReflection())
                return;
            Location spawn = _actor.getLoc();
            spawn.setH(PositionUtils.calculateHeadingFrom(spawn.getX(), spawn.getY(), _player.getX(), _player.getY()));
            NpcInstance npc = NpcUtils.spawnSingle(_nextId, spawn, _actor.getReflection());
