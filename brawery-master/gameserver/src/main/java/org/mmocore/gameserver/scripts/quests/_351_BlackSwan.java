        ...
        if (npcId == captain_gosta) {
            ...
            if (event.equalsIgnoreCase("reply_1")) {
                if (st.ownItemCount(q0351_lizard_fang) == 0) {
                    ...
                    if (st.ownItemCount(q0351_lizard_fang) >= 10)
                        st.giveReward(ADENA_ID, 3880 + 20 * st.ownItemCount(q0351_lizard_fang), true);
                    else
                        st.giveReward(ADENA_ID, 20 * st.ownItemCount(q0351_lizard_fang), true);
                ...
                if (st.ownItemCount(q0351_barrel_of_league) == 0) {
                    ...
                    st.setCond(2);
                    st.giveReward(q0351_bill_of_iason, st.ownItemCount(q0351_barrel_of_league), false);
                    st.giveReward(ADENA_ID, 3880, true);
            ...
            if (event.equalsIgnoreCase("reply_1")) {
                if (st.ownItemCount(q0351_bill_of_iason) > 0) {
                    st.giveReward(ADENA_ID, 700, true);
                ...
                if (st.ownItemCount(q0351_bill_of_iason) >= 6) {
                    ...
                    st.giveReward(ADENA_ID, 210, true);
                ...
                if (st.ownItemCount(q0351_bill_of_iason) >= 7) {
                    ...
                    st.giveReward(ADENA_ID, 280, true);
                ...
                if (st.ownItemCount(q0351_bill_of_iason) >= 9) {
                    ...
                    st.giveReward(ADENA_ID, 630, true);
                    st.takeItems(q0351_bill_of_iason, 9);
                    htmltext = "head_blacksmith_roman_q0351_03.htm";
                } else
                    htmltext = "head_blacksmith_roman_q0351_04.htm";
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (st.ownItemCount(q0351_order_of_gosta) > 0)
            if (npcId == tasaba_lizardman || npcId == tasaba_lizardman_a) {
                int i0 = Rnd.get(100);
                if (i0 < 10) {
                    st.giveItems(q0351_lizard_fang, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                    if (Rnd.get(20) == 0)
                        st.giveItems(q0351_barrel_of_league, 1, true);
                } else if (i0 < 15) {
                    st.giveItems(q0351_lizard_fang, 2, true);
                    st.soundEffect(SOUND_ITEMGET);
                    if (Rnd.get(20) == 0)
                        st.giveItems(q0351_barrel_of_league, 1, true);
