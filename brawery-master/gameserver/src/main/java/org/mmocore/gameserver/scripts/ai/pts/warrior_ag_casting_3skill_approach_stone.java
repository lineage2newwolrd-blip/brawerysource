...
public class warrior_ag_casting_3skill_approach_stone extends warrior_casting_3skill_approach_stone
{
	public int MeleeAttackerAg = -1;

	public warrior_ag_casting_3skill_approach_stone(final NpcInstance actor){super(actor);}
