...
public class wizard_ag_corpse_vampire_curse extends wizard_corpse_vampire_curse
{
	public wizard_ag_corpse_vampire_curse(final NpcInstance actor){super(actor);}
