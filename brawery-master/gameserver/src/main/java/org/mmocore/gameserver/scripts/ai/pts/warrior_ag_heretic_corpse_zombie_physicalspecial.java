...
public class warrior_ag_heretic_corpse_zombie_physicalspecial extends warrior_heretic_corpse_zombie_physicalspecial
{
	public warrior_ag_heretic_corpse_zombie_physicalspecial(final NpcInstance actor){super(actor);}
	...
	protected void onEvtSeeCreature(Creature creature)
	{
		...
		if (IsTeleport != 0 && GetLifeTime() > 7 && DistFromMe(creature) > 100 && p_state != State.ATTACK && AiUtils.Rand(100) < 10)
		{
