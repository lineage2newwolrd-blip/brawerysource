...
public class party_leader_ag_wd_corpse_necro extends party_leader_wd_corpse_necro
{
	public party_leader_ag_wd_corpse_necro(final NpcInstance actor){super(actor);}
