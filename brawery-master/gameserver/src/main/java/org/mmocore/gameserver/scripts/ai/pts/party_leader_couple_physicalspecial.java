...
public class party_leader_couple_physicalspecial extends party_leader_couple
{
	public int PhysicalSpecial = 264241153;

	public party_leader_couple_physicalspecial(final NpcInstance actor){super(actor);}
