...
public class wizard_casting_clanbuff_rangedd_curse_stone extends wizard_casting_clanbuff_rangedd_curse
{
	public int DeBuff1 = 295895041;

	public wizard_casting_clanbuff_rangedd_curse_stone(final NpcInstance actor){super(actor);}
