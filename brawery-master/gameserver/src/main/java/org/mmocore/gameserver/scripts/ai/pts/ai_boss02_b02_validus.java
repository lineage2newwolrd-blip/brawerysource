...
public class ai_boss02_b02_validus extends warrior_aggressive
{
	public int different_level_9_attacked = 295895041;
	public int different_level_9_see_spelled = 276234241;

	public ai_boss02_b02_validus(final NpcInstance actor){super(actor);}
