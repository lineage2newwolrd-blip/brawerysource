        ...
        if (npcId == galicbredo) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (st.ownItemCount(q_ancient_portrait) < 1)
                    ...
                    st.giveReward(ADENA_ID, st.ownItemCount(q_ancient_portrait) * 120 + 7800, true);
                    ...
                    st.giveReward(ADENA_ID, st.ownItemCount(q_ancient_portrait) * 120 + 2800, true);
                    st.takeItems(q_ancient_portrait, -1);
                ...
                if (st.ownItemCount(q_ancient_portrait) > 0)
                    st.giveReward(ADENA_ID, st.ownItemCount(q_ancient_portrait) * 120, true);
                st.takeItems(q_ancient_portrait, -1);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (id == 2)
            if (npcId == timak_orc_troop_leader) {
                int i0 = Rnd.get(1000);
                if (i0 < 560) {
                    st.giveItems(q_ancient_portrait, 1, true);
