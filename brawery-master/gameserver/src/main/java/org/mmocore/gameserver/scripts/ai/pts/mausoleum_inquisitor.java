...
public class mausoleum_inquisitor extends warrior_aggressive_casting_enchant_clan
{
	public mausoleum_inquisitor(final NpcInstance actor){super(actor);}
