...
public class timak_orc_troop_shaman extends party_private_casting_heal_curse
{
	public timak_orc_troop_shaman(final NpcInstance actor){super(actor);}
				...
				if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
				{
					...
					if (i1 != 0)
					{
						for (i0 = 0; i0 < i1; i0++)
						{
							...
							if (i2 > i3 && AiUtils.HaveMemo(c1, 355)!=0)
							{
								i3 = i2;
								c2 = c1;
							}
					...
					if (AiUtils.HaveMemo(c2, 355)!=0 && !IsNullCreature(c2) && DistFromMe(c2) <= 1500)
					{
						i0 = AiUtils.Rand(100);
