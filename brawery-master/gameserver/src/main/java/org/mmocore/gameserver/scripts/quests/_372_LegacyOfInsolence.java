...
public class _372_LegacyOfInsolence extends Quest {
        ...
        if (npcId == whouse_keeper_walderal) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (st.ownItemCount(tower_blueprint1) < 1 || st.ownItemCount(tower_blueprint2) < 1 || st.ownItemCount(tower_blueprint3) < 1 || st.ownItemCount(tower_blueprint4) < 1 || st.ownItemCount(tower_blueprint5) < 1 || st.ownItemCount(tower_blueprint6) < 1 || st.ownItemCount(tower_blueprint7) < 1 || st.ownItemCount(tower_blueprint8) < 1 || st.ownItemCount(tower_blueprint9) < 1 || st.ownItemCount(tower_blueprint10) < 1 || st.ownItemCount(tower_blueprint11) < 1 || st.ownItemCount(tower_blueprint12) < 1 || st.ownItemCount(tower_blueprint13) < 1)
                    ...
                    int i1 = Rnd.get(100);
                    if (i1 < 10)
                        st.giveReward(sealed_dark_crystal_boots_lining, 1, true);
                    else if (i1 < 20)
                        st.giveReward(sealed_dark_crystal_gloves_design, 1, true);
                    else if (i1 < 30)
                        st.giveReward(sealed_dark_crystal_helmet_design, 1, true);
                    else if (i1 < 40) {
                        st.giveReward(sealed_dark_crystal_boots_lining, 1, true);
                        st.giveReward(sealed_dark_crystal_gloves_design, 1, true);
                        st.giveReward(sealed_dark_crystal_helmet_design, 1, true);
                    } else if (i1 < 51)
                        st.giveReward(rp_sealed_dark_crystal_boots_i, 1, true);
                    else if (i1 < 62)
                        st.giveReward(rp_sealed_dark_crystal_gloves_i, 1, true);
                    else if (i1 < 79)
                        st.giveReward(rp_sealed_dark_crystal_helmet_i, 1, true);
                    else if (i1 < 100) {
                        st.giveReward(rp_sealed_dark_crystal_boots_i, 1, true);
                        st.giveReward(rp_sealed_dark_crystal_gloves_i, 1, true);
                        st.giveReward(rp_sealed_dark_crystal_helmet_i, 1, true);
                ...
                if (st.ownItemCount(tower_blueprint1) < 1 || st.ownItemCount(tower_blueprint2) < 1 || st.ownItemCount(tower_blueprint3) < 1 || st.ownItemCount(tower_blueprint4) < 1 || st.ownItemCount(tower_blueprint5) < 1 || st.ownItemCount(tower_blueprint6) < 1 || st.ownItemCount(tower_blueprint7) < 1 || st.ownItemCount(tower_blueprint8) < 1 || st.ownItemCount(tower_blueprint9) < 1 || st.ownItemCount(tower_blueprint10) < 1 || st.ownItemCount(tower_blueprint11) < 1 || st.ownItemCount(tower_blueprint12) < 1 || st.ownItemCount(tower_blueprint13) < 1)
                    ...
                    int i1 = Rnd.get(100);
                    if (i1 < 10)
                        st.giveReward(sealed_tallum_boots_lining, 1, true);
                    else if (i1 < 20)
                        st.giveReward(sealed_tallum_gloves_design, 1, true);
                    else if (i1 < 30)
                        st.giveReward(sealed_tallum_bonnet_design, 1, true);
                    else if (i1 < 40) {
                        st.giveReward(sealed_tallum_boots_lining, 1, true);
                        st.giveReward(sealed_tallum_gloves_design, 1, true);
                        st.giveReward(sealed_tallum_bonnet_design, 1, true);
                    } else if (i1 < 51)
                        st.giveReward(rp_sealed_tallum_boots_i, 1, true);
                    else if (i1 < 62)
                        st.giveReward(rp_sealed_tallum_gloves_i, 1, true);
                    else if (i1 < 79)
                        st.giveReward(rp_sealed_tallum_bonnet_i, 1, true);
                    else if (i1 < 100) {
                        st.giveReward(rp_sealed_tallum_boots_i, 1, true);
                        st.giveReward(rp_sealed_tallum_gloves_i, 1, true);
                        st.giveReward(rp_sealed_tallum_bonnet_i, 1, true);
                ...
                if (st.ownItemCount(tower_blueprint1) < 1 || st.ownItemCount(tower_blueprint2) < 1 || st.ownItemCount(tower_blueprint3) < 1 || st.ownItemCount(tower_blueprint4) < 1 || st.ownItemCount(tower_blueprint5) < 1 || st.ownItemCount(tower_blueprint6) < 1 || st.ownItemCount(tower_blueprint7) < 1 || st.ownItemCount(tower_blueprint8) < 1 || st.ownItemCount(tower_blueprint9) < 1 || st.ownItemCount(tower_blueprint10) < 1 || st.ownItemCount(tower_blueprint11) < 1 || st.ownItemCount(tower_blueprint12) < 1 || st.ownItemCount(tower_blueprint13) < 1)
                    ...
                    int i1 = Rnd.get(100);
                    if (i1 < 17)
                        st.giveReward(sealed_boots_of_nightmare_lining, 1, true);
                    else if (i1 < 34)
                        st.giveReward(sealed_gloves_of_nightmare_design, 1, true);
                    else if (i1 < 49)
                        st.giveReward(sealed_helm_of_nightmare_design, 1, true);
                    else if (i1 < 58) {
                        st.giveReward(sealed_boots_of_nightmare_lining, 1, true);
                        st.giveReward(sealed_gloves_of_nightmare_design, 1, true);
                        st.giveReward(sealed_helm_of_nightmare_design, 1, true);
                    } else if (i1 < 70)
                        st.giveReward(rp_sealed_boots_of_nightmare_i, 1, true);
                    else if (i1 < 82)
                        st.giveReward(rp_sealed_gloves_of_nightmare_i, 1, true);
                    else if (i1 < 92)
                        st.giveReward(rp_sealed_helm_of_nightmare_i, 1, true);
                    else if (i1 < 100) {
                        st.giveReward(rp_sealed_boots_of_nightmare_i, 1, true);
                        st.giveReward(rp_sealed_gloves_of_nightmare_i, 1, true);
                        st.giveReward(rp_sealed_helm_of_nightmare_i, 1, true);
                ...
                if (st.ownItemCount(tower_blueprint1) < 1 || st.ownItemCount(tower_blueprint2) < 1 || st.ownItemCount(tower_blueprint3) < 1 || st.ownItemCount(tower_blueprint4) < 1 || st.ownItemCount(tower_blueprint5) < 1 || st.ownItemCount(tower_blueprint6) < 1 || st.ownItemCount(tower_blueprint7) < 1 || st.ownItemCount(tower_blueprint8) < 1 || st.ownItemCount(tower_blueprint9) < 1 || st.ownItemCount(tower_blueprint10) < 1 || st.ownItemCount(tower_blueprint11) < 1 || st.ownItemCount(tower_blueprint12) < 1 || st.ownItemCount(tower_blueprint13) < 1)
                    ...
                    int i1 = Rnd.get(100);
                    if (i1 < 17)
                        st.giveReward(sealed_magestic_boots_lining, 1, true);
                    else if (i1 < 34)
                        st.giveReward(sealed_magestic_gloves_design, 1, true);
                    else if (i1 < 49)
                        st.giveReward(sealed_magestic_circlet_design, 1, true);
                    else if (i1 < 58) {
                        st.giveReward(sealed_magestic_boots_lining, 1, true);
                        st.giveReward(sealed_magestic_gloves_design, 1, true);
                        st.giveReward(sealed_magestic_circlet_design, 1, true);
                    } else if (i1 < 70)
                        st.giveReward(rp_sealed_magestic_boots_i, 1, true);
                    else if (i1 < 82)
                        st.giveReward(rp_sealed_magestic_gloves_i, 1, true);
                    else if (i1 < 92)
                        st.giveReward(rp_sealed_magestic_circlet_i, 1, true);
                    else if (i1 < 100) {
                        st.giveReward(rp_sealed_magestic_boots_i, 1, true);
                        st.giveReward(rp_sealed_magestic_gloves_i, 1, true);
                        st.giveReward(rp_sealed_magestic_circlet_i, 1, true);
                ...
                if (npcId == whouse_keeper_walderal) {
                    ...
                    if (st.ownItemCount(imperial_genealogy1) < 1 || st.ownItemCount(imperial_genealogy2) < 1 || st.ownItemCount(imperial_genealogy3) < 1 || st.ownItemCount(imperial_genealogy4) < 1 || st.ownItemCount(imperial_genealogy5) < 1)
                        ...
                        if (i1 < 30)
                            ...
                            st.giveReward(ADENA_ID, 4000, true);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == corrypt_sage) {
            if (Rnd.get(1000) < 302) {
                st.giveItems(ancient_papyrus1, 1, true);
            ...
            if (Rnd.get(1000) < 451) {
                st.giveItems(ancient_papyrus2, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            }
        } else if (npcId == plat_protect_warlord) {
            if (Rnd.get(100) < 28) {
                st.giveItems(ancient_papyrus3, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            }
        } else if (npcId == messenger_angel_r) {
            if (Rnd.get(100) < 29) {
                st.giveItems(ancient_papyrus4, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            }
        }
        return null;
