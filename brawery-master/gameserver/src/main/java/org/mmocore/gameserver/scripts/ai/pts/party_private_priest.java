...
public class party_private_priest extends party_private
{
	...
	public party_private_priest(final NpcInstance actor){super(actor);}
	...
	protected void onEvtSeeCreature(Creature creature)
	{
		...
		if (!creature.isPlayer() && !IsInCategory(Category.summon_npc_group, creature.getClassId()) && creature == boss)
		{
