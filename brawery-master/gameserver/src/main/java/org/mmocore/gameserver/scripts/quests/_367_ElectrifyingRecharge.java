            ...
            case STARTED:
                if (npcId == researcher_lorain) {
                    if (st.ownItemCount(q_giants_lamp5) == 0 && st.ownItemCount(q_giants_broken_lamp) == 0)
                        ...
                        int i0 = Rnd.get(14);
                        if (i0 == 0)
                            st.giveReward(dye_s1c1_c, 1, true);
                        else if (i0 == 1)
                            st.giveReward(dye_s1d1_c, 1, true);
                        else if (i0 == 2)
                            st.giveReward(dye_c1s1_c, 1, true);
                        else if (i0 == 3)
                            st.giveReward(dye_c1c1_c, 1, true);
                        else if (i0 == 4)
                            st.giveReward(dye_d1s1_c, 1, true);
                        else if (i0 == 5)
                            st.giveReward(dye_d1c1_c, 1, true);
                        else if (i0 == 6)
                            st.giveReward(dye_i1m1_c, 1, true);
                        else if (i0 == 7)
                            st.giveReward(dye_i1w1_c, 1, true);
                        else if (i0 == 8)
                            st.giveReward(dye_m1i1_c, 1, true);
                        else if (i0 == 9)
                            st.giveReward(dye_m1w1_c, 1, true);
                        else if (i0 == 10)
                            st.giveReward(dye_w1i1_c, 1, true);
                        else if (i0 == 11)
                            st.giveReward(dye_w1m1_c, 1, true);
                        else
                            st.giveReward(dye_s1c3_d, 1, true);
