...
public class splinter_stakato_soldier extends warrior_run_away_physicalspecial
{
	public splinter_stakato_soldier(final NpcInstance actor){super(actor);}
