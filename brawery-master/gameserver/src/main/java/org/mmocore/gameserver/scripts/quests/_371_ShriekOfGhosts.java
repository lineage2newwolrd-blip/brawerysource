        ...
        if (npcId == seer_reva) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (st.ownItemCount(ancient_funeral_urn) < 1)
                    ...
                    st.giveReward(ADENA_ID, st.ownItemCount(ancient_funeral_urn) * 1000 + 15000, true);
                    st.takeItems(ancient_funeral_urn, -1);
                    htmltext = "seer_reva_q0371_07.htm";
                } else if (st.ownItemCount(ancient_funeral_urn) >= 100) {
                    st.giveReward(ADENA_ID, st.ownItemCount(ancient_funeral_urn) * 1000 + 37700, true);
                    st.takeItems(ancient_funeral_urn, -1);
                ...
                if (st.ownItemCount(ancient_funeral_urn) > 0)
                    st.giveReward(ADENA_ID, st.ownItemCount(ancient_funeral_urn) * 1000, true);
                st.takeItems(ancient_funeral_urn, -1);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (GetMemoState == 1)
            if (npcId == hallates_warrior) {
                int i4 = Rnd.get(1000);
                if (i4 < 350) {
                    st.giveItems(ancient_funeral_urn, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                } else if (i4 < 400) {
                    st.giveItems(ancient_porcelain, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                }
