...
{
	public great_demon_king(final NpcInstance actor){super(actor);}
	...
	protected void onEvtTimerFiredEx(int timer_id)
	{
		...
		{
			Despawn();
			Say(AiUtils.MakeFString(33409, "", "", "", "", ""));
			Say(AiUtils.MakeFString(33410, "", "", "", "", ""));
		}
