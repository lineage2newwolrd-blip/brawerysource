    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("quest_accept")) {
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 326) {
                st.giveReward(rp_sealed_dynasty_blast_plate_i, 1, true);
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 204) {
                ...
                st.giveReward(rp_sealed_dynasty_gaiter_i, 1, true);
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 122) {
                ...
                st.giveReward(rp_sealed_dynasty_helmet_i, 1, true);
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 82) {
                ...
                st.giveReward(rp_sealed_dynasty_gauntlet_i, 1, true);
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 82) {
                ...
                st.giveReward(rp_sealed_dynasty_boots_i, 1, true);
                st.takeItems(q_ragna_orc_totem, 82);
                htmltext = "cheiren_q0311_09.htm";
            } else
                htmltext = "cheiren_q0311_10.htm";
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 244) {
                ...
                st.giveReward(rp_sealed_dynasty_leather_mail_i, 1, true);
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 153) {
                ...
                st.giveReward(rp_sealed_dynasty_leather_legging_i, 1, true);
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 122) {
                ...
                st.giveReward(rp_sealed_dynasty_leather_helmet_i, 1, true);
                st.takeItems(q_ragna_orc_totem, 122);
                htmltext = "cheiren_q0311_09.htm";
            } else
                htmltext = "cheiren_q0311_10.htm";
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 82) {
                ...
                st.giveReward(rp_sealed_dynasty_leather_gloves_i, 1, true);
                st.takeItems(q_ragna_orc_totem, 82);
                htmltext = "cheiren_q0311_09.htm";
            } else
                htmltext = "cheiren_q0311_10.htm";
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 82) {
                ...
                st.giveReward(rp_sealed_dynasty_leather_boots_i, 1, true);
                st.takeItems(q_ragna_orc_totem, 82);
                htmltext = "cheiren_q0311_09.htm";
            } else
                htmltext = "cheiren_q0311_10.htm";
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 86) {
                ...
                st.giveReward(rp_sealed_dynasty_shield_i, 1, true);
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 43) {
                ...
                st.giveReward(adamantium, 1, true);
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 36) {
                ...
                st.giveReward(oricalcum, 1, true);
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 667) {
                ...
                st.giveReward(codex_of_giant_forgetting, 1, true);
            ...
            if (st.ownItemCount(q_ragna_orc_totem) >= 1000) {
                ...
                st.giveReward(codex_of_giant_training, 1, true);
            ...
            if (GetMemoState == 1 && st.ownItemCount(q_evil_soul_core) >= 10) {
                st.giveReward(q_charm_of_protection, 1, false);
            ...
            if (npcId == ragna_orc_re) {
                ...
                if (GetMemoStateEx >= 100) {
                    ...
                    if (i1 < GetMemoStateEx % 100 + 1) {
                        st.setMemoState("disperse_the_evil_spirit_ex", String.valueOf(0), true);
                        st.giveItems(q_evil_soul_core, 1, true);
                        st.soundEffect(SOUND_ITEMGET);
                    }
                }
                int i0 = Rnd.get(1000);
                if (i0 < 694) {
                    st.giveItems(q_ragna_orc_totem, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                }
