                ...
                if (npcId == sentinel_rayjien) {
                    if (st.ownItemCount(orc_amulet1) == 0 && st.ownItemCount(orc_necklace1) == 0)
                        ...
                        if (st.ownItemCount(orc_amulet1) + st.ownItemCount(orc_necklace1) >= 10)
                            st.giveReward(ADENA_ID, st.ownItemCount(orc_amulet1) * 12 + st.ownItemCount(orc_necklace1) * 30 + 1000, true);
                        else
                            st.giveReward(ADENA_ID, st.ownItemCount(orc_amulet1) * 12 + st.ownItemCount(orc_necklace1) * 30, true);
