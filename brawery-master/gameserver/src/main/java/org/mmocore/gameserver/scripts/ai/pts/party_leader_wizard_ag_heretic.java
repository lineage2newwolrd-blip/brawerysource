...
public class party_leader_wizard_ag_heretic extends party_leader_wizard_heretic
{
	public party_leader_wizard_ag_heretic(final NpcInstance actor){super(actor);}
	...
	protected void onEvtSeeCreature(Creature creature)
	{
		...
		if (GetLifeTime() > 7 && InMyTerritory(actor) && GetHateInfoCount() == 0)
		{
			...
			{
				BroadcastScriptEventEx(ScriptEvent.SCE_PROTECT_LEADER, AiUtils.GetIndexFromCreature(creature), AiUtils.GetIndexFromCreature(actor), HelpCastRange);
			}
