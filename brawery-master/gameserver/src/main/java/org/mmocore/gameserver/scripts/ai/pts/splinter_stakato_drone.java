...
public class splinter_stakato_drone extends warrior_run_away_physicalspecial
{
	public splinter_stakato_drone(final NpcInstance actor){super(actor);}
