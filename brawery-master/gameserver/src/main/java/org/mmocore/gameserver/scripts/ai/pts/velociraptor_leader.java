...
public class velociraptor_leader extends roamer_primeval
{
	public velociraptor_leader(final NpcInstance actor){super(actor);}
		...
		if (!AiUtils.IsNull(code_info))
		{
			switch (code_info.getCode())
			{
				case 1:
				{
					...
					{
						i4 = AiUtils.Rand(1000);
						if (i4 < 510 && AiUtils.OwnItemCount(target, 8768) <= 49)
						{
