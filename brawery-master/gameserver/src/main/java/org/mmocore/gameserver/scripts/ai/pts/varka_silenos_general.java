...
public class varka_silenos_general extends party_leader_ag_patrol_physicalspecial_stone
{
	public varka_silenos_general(final NpcInstance actor){super(actor);}
