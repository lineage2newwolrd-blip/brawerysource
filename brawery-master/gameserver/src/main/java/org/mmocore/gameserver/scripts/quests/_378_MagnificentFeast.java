...
public class _378_MagnificentFeast extends Quest {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("quest_accept") && _state == CREATED) {
            ...
            if (cond == 1 && st.ownItemCount(WINE_15) > 0) {
                ...
                st.setCond(2);
                st.setMemoState("score", String.valueOf(score + 1));
            } else {
            ...
            if (cond == 1 && st.ownItemCount(WINE_30) > 0) {
                ...
                st.setCond(2);
                st.setMemoState("score", String.valueOf(score + 2));
            } else {
                htmltext = "warehouse_chief_ranspo_q0378_08.htm";
            }
            ...
            if (cond == 1 && st.ownItemCount(WINE_60) > 0) {
                ...
                st.setCond(2);
                st.setMemoState("score", String.valueOf(score + 4));
            } else {
                htmltext = "warehouse_chief_ranspo_q0378_08.htm";
            }
        } else if (event.equalsIgnoreCase("378_5") && _state == STARTED) {
            if (cond == 2 && st.ownItemCount(Musical_Score__Theme_of_the_Feast) > 0) {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (_state == CREATED) {
            ...
            htmltext = st.ownItemCount(Musical_Score__Theme_of_the_Feast) > 0 ? "warehouse_chief_ranspo_q0378_11.htm" : "warehouse_chief_ranspo_q0378_10.htm";
            ...
            if (st.ownItemCount(Ritrons_Dessert_Recipe) > 0 && reward != null) {
                ...
                if (reward[2] > 0) {
                    st.giveReward(ADENA_ID, reward[2], true);
                }
