...
public class party_private_casting_ddmagic_curse_stone extends party_private_casting_ddmagic_curse
{
	public int DeBuff1 = 295895041;

	public party_private_casting_ddmagic_curse_stone(final NpcInstance actor){super(actor);}
