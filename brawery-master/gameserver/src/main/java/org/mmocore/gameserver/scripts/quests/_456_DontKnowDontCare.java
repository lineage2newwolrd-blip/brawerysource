                ...
                if (npcId == separated_soul_01 || npcId == separated_soul_02 || npcId == separated_soul_03 || npcId == separated_soul_04 || npcId == separated_soul_05 || npcId == separated_soul_06 || npcId == separated_soul_07 || npcId == separated_soul_08) {
                    if (GetMemoState == 1) {
                        if (st.ownItemCount(q_marrow_of_drake_lord) == 0 && st.ownItemCount(q_marrow_of_behemoth_leader) == 0 && st.ownItemCount(q_marrow_of_dragon_beast) == 0) {
                            ...
                            double i0 = Rnd.get(100000d * (1d / Math.min(st.getRateQuestsReward(), 25)));
                            if (i0 < 100) {
                                ...
                                st.giveReward(high_ore_of_fire, 1, true);
                                ...
                                st.giveReward(high_ore_of_water, 1, true);
                                ...
                                st.giveReward(high_ore_of_earth, 1, true);
                                ...
                                st.giveReward(high_ore_of_wind, 1, true);
                                ...
                                st.giveReward(high_ore_of_holy, 1, true);
                                ...
                                st.giveReward(high_ore_of_unholy, 1, true);
                                ...
                                st.giveReward(scrl_of_ench_wp_s, 1, true);
                                ...
                                st.giveReward(gemstone_s, 3, true);
