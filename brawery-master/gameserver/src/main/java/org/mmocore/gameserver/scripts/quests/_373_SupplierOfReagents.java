...
public class _373_SupplierOfReagents extends Quest {
        ...
        if (npcId == bandor) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                if (st.ownItemCount(necroplasm) >= 1) {
                    ...
                    int i0 = Rnd.get(100);
                    if (i0 < 32)
                        st.giveReward(enria, 1, true);
                    else if (i0 < 66)
                        st.giveReward(asofe, 1, true);
                    else
                        st.giveReward(thons, 1, true);
                    st.giveReward(ADENA_ID, 500, true);
                ...
                if (st.ownItemCount(lunargent) >= 1) {
                    ...
                    int i0 = Rnd.get(100);
                    if (i0 < 20)
                        st.giveReward(sealed_dark_crystal_leather_mail_pattern, 2, true);
                    else if (i0 < 40)
                        st.giveReward(sealed_tallum_leather_mail_pattern, 2, true);
                    else if (i0 < 60)
                        st.giveReward(sealed_leather_mail_of_nightmare_fabric, 2, true);
                    else if (i0 < 80)
                        st.giveReward(sealed_majestic_leather_mail_fabric, 2, true);
                    else
                        st.giveReward(sealed_legging_of_dark_crystal_design, 2, true);
                    st.giveReward(ADENA_ID, 8000, true);
                ...
                if (st.ownItemCount(midnight_oil) >= 1) {
                    ...
                    int i0 = Rnd.get(100);
                    if (i0 < 20)
                        st.giveReward(sealed_dark_crystal_breastplate_pattern, 3, true);
                    else if (i0 < 40)
                        st.giveReward(sealed_tallum_plate_armor_pattern, 3, true);
                    else if (i0 < 60)
                        st.giveReward(sealed_armor_of_nightmare_pattern, 3, true);
                    else if (i0 < 80)
                        st.giveReward(sealed_majestic_platte_armor_pattern, 3, true);
                    else
                        st.giveReward(sealed_dark_crystal_gaiters_pattern, 3, true);
                    st.giveReward(ADENA_ID, 8000, true);
                ...
                if (st.ownItemCount(demonic_essence) >= 1) {
                    ...
                    int i0 = Rnd.get(100);
                    if (i0 < 40)
                        st.giveReward(ADENA_ID, 320000, true);
                    else if (i0 < 80)
                        st.giveReward(ADENA_ID, 245000, true);
                    else
                        st.giveReward(ADENA_ID, 160000, true);
                ...
                if (st.ownItemCount(abyss_oil) >= 1) {
                    ...
                    st.giveReward(ADENA_ID, 5000, true);
                ...
                if (st.ownItemCount(nightmare_oil) >= 1) {
                    ...
                    st.giveReward(ADENA_ID, 19000, true);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == credion) {
            int i4 = Rnd.get(1000);
            if (i4 < 618) {
                st.giveItems(decaying_bone, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            } else if (i4 < 1000) {
                st.giveItems(quicksilver, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            }
        } else if (npcId == hallates_maiden) {
            int i4 = Rnd.get(100);
            if (i4 < 45) {
                st.giveItems(ingredient_pouch1, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            } else if (i4 < 65) {
                st.giveItems(volcanic_ash, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            }
        } else if (npcId == platinum_tribe_shaman) {
            int i4 = Rnd.get(1000);
            if (i4 < 658) {
                st.giveItems(ingredient_pouch2, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            } else if (i4 < 100) {
                st.giveItems(quicksilver, 2, true);
                st.soundEffect(SOUND_ITEMGET);
            }
        } else if (npcId == hallates_guardian) {
            int i4 = Rnd.get(1000);
            if (i4 < 766) {
                st.giveItems(demons_blood, 3, true);
                st.soundEffect(SOUND_ITEMGET);
            } else if (i4 < 876) {
                st.giveItems(moonstone_shard, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            }
        } else if (npcId == plat_protect_shaman) {
            int i4 = Rnd.get(1000);
            if (i4 < 444) {
                st.giveItems(ingredient_box, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            }
        } else if (npcId == lava_wyrm) {
            int i4 = Rnd.get(1000);
            if (i4 < 666) {
                st.giveItems(wyrms_blood, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            } else if (i4 < 989) {
                st.giveItems(lava_stone, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            }
        } else if (npcId == hames_orc_shaman) {
            int i4 = Rnd.get(1000);
            if (i4 < 616) {
                st.giveItems(ingredient_pouch3, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            }
        }
        return null;
