...
public class warrior_ag_physicalspecial_potion extends warrior_physicalspecial_potion
{
	public warrior_ag_physicalspecial_potion(final NpcInstance actor){super(actor);}
