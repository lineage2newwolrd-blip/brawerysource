...
public class _219_TestimonyOfFate extends Quest {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        int cond = st.getCond();
        if (npcId == Kaira) {
            if (st.ownItemCount(MarkofFate) != 0) {
                htmltext = "completed";
                st.exitQuest(true);
            } else if (cond == 0) {
                ...
                if (AldersSpiritObject == null) {
                    ...
                    if (st.ownItemCount(AldersSkull2) == 0) {
                    ...
                    st.startQuestTimer("AldersSpirit_Fail", 300000, npc);
                } else {
                ...
                if (st.ownItemCount(KairasInstructions) != 0 && st.getPlayer().getLevel() < 38) {
                    htmltext = "30476-14.htm";
                } else if (st.ownItemCount(KairasInstructions) != 0 && st.getPlayer().getLevel() >= 38) {
                    st.giveItems(KairasRecommendation, 1);
            ...
            } else if (st.ownItemCount(MetheussFuneralJar) > 0 || st.ownItemCount(KasandrasRemains) > 0) {
                htmltext = "30476-07.htm";
            } else if (st.ownItemCount(HerbalismTextbook) > 0 || st.ownItemCount(IxiasList) > 0) {
                htmltext = "30476-08.htm";
            } else if (st.ownItemCount(AldersSkull2) > 0 || st.ownItemCount(AldersReceipt) > 0) {
            ...
            } else if (st.ownItemCount(AldersSkull1) > 0 || st.ownItemCount(AldersSkull2) > 0 || st.ownItemCount(AldersReceipt) > 0 || st.ownItemCount(RevelationsManuscript) > 0 || st.ownItemCount(KairasInstructions) > 0 || st.ownItemCount(KairasRecommendation) > 0) {
            ...
            } else if (cond == 7 && st.ownItemCount(MedusasIchor) >= 10 && st.ownItemCount(MarshSpiderFluids) >= 10 && st.ownItemCount(DeadSeekerDung) >= 10 && st.ownItemCount(TyrantsBlood) >= 10 && st.ownItemCount(NightshadeRoot) >= 10) {
            ...
            } else if (st.ownItemCount(RevelationsManuscript) > 0 || st.ownItemCount(KairasInstructions) > 0 || st.ownItemCount(KairasRecommendation) > 0) {
            ...
            if (cond == 15) {
                ...
                if (!st.getPlayer().getPlayerVariables().getBoolean(PlayerVariables.PROF2_2)) {
                    ...
                    st.giveReward(ADENA_ID, 247708, true);
            ...
            if (cond == 16) {
                ...
                if (st.ownItemCount(RedFairyDust) < 1 || st.ownItemCount(BlightTreantSap) < 1) {
                    htmltext = "30419-03.htm";
                } else if (st.ownItemCount(RedFairyDust) >= 1 && st.ownItemCount(BlightTreantSap) >= 1) {
            ...
            if (st.ownItemCount(RedFairyDust) == 0 && st.ownItemCount(PixyGarnet) == 0) {
                htmltext = "31845-01.htm";
            } else if (st.ownItemCount(RedFairyDust) == 0 && st.ownItemCount(PixyGarnet) > 0 && (st.ownItemCount(GrandissSkull) < 10 || st.ownItemCount(KarulBugbearSkull) < 10 || st.ownItemCount(BrekaOverlordSkull) < 10 || st.ownItemCount(LetoOverlordSkull) < 10)) {
            ...
            } else if (st.ownItemCount(RedFairyDust) != 0) {
                htmltext = "31845-05.htm";
            }
        } else if (npcId == BlightTreant && cond == 17) {
            if (st.ownItemCount(BlightTreantSap) == 0 && st.ownItemCount(BlightTreantSeed) == 0) {
                htmltext = "31850-01.htm";
            } else if (st.ownItemCount(BlightTreantSap) == 0 && st.ownItemCount(BlightTreantSeed) > 0 && st.ownItemCount(BlackWillowLeaf) == 0) {
            ...
            } else if (st.ownItemCount(BlightTreantSap) > 0) {
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (cond == 2 && npcId == HangmanTree) {
            ...
            st.setCond(3);
            st.setState(STARTED);
        } else if (cond == 6 && st.ownItemCount(MedusasIchor) >= 10 && st.ownItemCount(MarshSpiderFluids) >= 10 && st.ownItemCount(DeadSeekerDung) >= 10 && st.ownItemCount(TyrantsBlood) >= 10 && st.ownItemCount(NightshadeRoot) >= 10) {
            st.setCond(7);
            st.setState(STARTED);
        }
        return null;
