    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == lavasaurus_lv1) {
            if (GetMemoState == 1 && st.ownItemCount(g_stone_of_lavasaurus1) < 10) {
                st.giveItems(g_stone_of_lavasaurus1, 1, true);
                if (st.ownItemCount(g_stone_of_lavasaurus1) >= 10 && st.ownItemCount(g_head_part_of_lavasaurus1) >= 10 && st.ownItemCount(g_body_part_of_lavasaurus1) >= 10 && st.ownItemCount(g_horn_part_of_lavasaurus1) >= 10) {
                    st.setCond(2);
            ...
            if (GetMemoState == 1 && st.ownItemCount(g_head_part_of_lavasaurus1) < 10) {
                st.giveItems(g_head_part_of_lavasaurus1, 1, true);
                if (st.ownItemCount(g_stone_of_lavasaurus1) >= 10 && st.ownItemCount(g_head_part_of_lavasaurus1) >= 10 && st.ownItemCount(g_body_part_of_lavasaurus1) >= 10 && st.ownItemCount(g_horn_part_of_lavasaurus1) >= 10) {
                    st.setCond(2);
                    st.soundEffect(SOUND_MIDDLE);
                } else {
            ...
            if (GetMemoState == 1 && st.ownItemCount(g_body_part_of_lavasaurus1) < 10) {
                st.giveItems(g_body_part_of_lavasaurus1, 1, true);
                if (st.ownItemCount(g_stone_of_lavasaurus1) >= 10 && st.ownItemCount(g_head_part_of_lavasaurus1) >= 10 && st.ownItemCount(g_body_part_of_lavasaurus1) >= 10 && st.ownItemCount(g_horn_part_of_lavasaurus1) >= 10) {
                    st.setCond(2);
                    st.soundEffect(SOUND_MIDDLE);
                } else {
            ...
            if (GetMemoState == 1 && st.ownItemCount(g_horn_part_of_lavasaurus1) < 10) {
                st.giveItems(g_horn_part_of_lavasaurus1, 1, true);
                if (st.ownItemCount(g_stone_of_lavasaurus1) >= 10 && st.ownItemCount(g_head_part_of_lavasaurus1) >= 10 && st.ownItemCount(g_body_part_of_lavasaurus1) >= 10 && st.ownItemCount(g_horn_part_of_lavasaurus1) >= 10) {
                    st.setCond(2);
                    st.soundEffect(SOUND_MIDDLE);
                } else {
