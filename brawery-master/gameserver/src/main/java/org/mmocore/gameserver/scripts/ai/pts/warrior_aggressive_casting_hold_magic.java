...
public class warrior_aggressive_casting_hold_magic extends warrior_casting_hold_magic
{
	public warrior_aggressive_casting_hold_magic(final NpcInstance actor){super(actor);}
