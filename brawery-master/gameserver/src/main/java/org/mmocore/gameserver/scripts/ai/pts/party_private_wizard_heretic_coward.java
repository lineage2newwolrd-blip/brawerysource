...
public class party_private_wizard_heretic_coward extends party_private_wizard_dd2_curse
{
	public party_private_wizard_heretic_coward(final NpcInstance actor){super(actor);}
	...
	protected void onEvtPartyDead(Creature attacker, NpcInstance privat)
	{
		...
		if (privat == boss)
		{
			AddFleeDesireEx(privat, 500, 10000000);
			Despawn();
		}
