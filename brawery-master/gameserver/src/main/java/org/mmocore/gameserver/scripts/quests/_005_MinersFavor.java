        ...
        if (npcId == miner_bolter) {
            ...
            if (event.equalsIgnoreCase("reply_1")) {
                if (st.ownItemCount(bolters_smelly_socks) > 0) {
                    ...
                    if (st.ownItemCount(mining_boots) + st.ownItemCount(miners_pick) + st.ownItemCount(boomboom_powder) + st.ownItemCount(redstone_beer) >= 4) {
                        st.setCond(2);
            ...
            case STARTED: {
                if (npcId == miner_bolter) {
                    if (st.ownItemCount(bolters_list) > 0 && st.ownItemCount(mining_boots) + st.ownItemCount(miners_pick) + st.ownItemCount(boomboom_powder) + st.ownItemCount(redstone_beer) < 4) {
                        ...
                        st.giveReward(necklace_of_knowledge, 1, false);
                        st.addExpAndSp(5672, 446);
                        st.giveReward(ADENA_ID, 2466, true);
