...
public class _660_AidingtheFloranVillage extends Quest {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (npcId == marya) {
            ...
            if (event.equalsIgnoreCase("menu_select?ask=660&reply=1")) {
                ...
                long i0 = i1 + i2 + i3;
                if (i0 > 0) {
                    st.giveReward(ADENA_ID, i0 * 100, true);
                ...
                if (i0 < 100)
                    ...
                    if (Rnd.get(99) > 50) {
                        ...
                        st.giveReward(ADENA_ID, 13000, true);
                ...
                if (i0 < 200)
                    ...
                    if (Rnd.get(100) >= 50) {
                        if (Rnd.get(2) == 0) {
                            ...
                            st.giveReward(scrl_of_ench_wp_d, 1, true);
                        htmltext = "alankell_q0660_16.htm";
                    } else {
                        st.giveReward(ADENA_ID, 2000, true);
                ...
                if (i0 < 500)
                    ...
                    if (Rnd.get(100) >= 50) {
                        st.giveReward(scrl_of_ench_wp_d, 1, true);
                        st.giveReward(ADENA_ID, 45000, true);
                ...
                if (i0 <= 0)
                    ...
                    long i4 = i0 * 100;
                    st.giveReward(ADENA_ID, i4, true);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (npcId == delu_lizardman_shaman || npcId == delu_lizardman_q_master) {
            if (GetMemoState == 2) {
                if (Rnd.get(100) < 65) {
                    st.giveItems(q_scale_of_delu_lizardman, 1, true);
                    st.soundEffect(SOUND_ITEMGET);
                }
            }
        } else if (npcId == plain_observer) {
            if (Rnd.get(100) < 50) {
                st.giveItems(q_eye_of_observer, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            }
        } else if (npcId == oddly_stone_golem) {
            if (Rnd.get(100) < 52) {
                st.giveItems(q_part_of_oddy_stone_golem, 1, true);
                st.soundEffect(SOUND_ITEMGET);
            }
            ...
            if (Rnd.get(100) < 33) {
                st.giveItems(q_scale_of_delu_lizardman, 2, true);
                st.soundEffect(SOUND_ITEMGET);
            } else {
                st.giveItems(q_scale_of_delu_lizardman, 1, true);
                st.soundEffect(SOUND_ITEMGET);
