...
public class saitnn_puppet extends party_private_casting_heal_curse
{
	public saitnn_puppet(final NpcInstance actor){super(actor);}
				...
				case 0:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						if (AiUtils.Rand(100) < 80)
						{
							...
							i2 = 0;
							if (i1 == 0 && AiUtils.HaveMemo(c1, 366)!=0)
							{
								c2 = c1;
							}
							for (i0 = 0; i0 < i1; i0++)
