...
public class warrior_ag_casting_ddmagic_selfbuff extends warrior_casting_ddmagic_selfbuff
{
	public warrior_ag_casting_ddmagic_selfbuff(final NpcInstance actor){super(actor);}
