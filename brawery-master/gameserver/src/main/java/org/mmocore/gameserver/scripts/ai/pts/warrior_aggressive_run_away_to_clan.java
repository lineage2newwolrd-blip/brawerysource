...
public class warrior_aggressive_run_away_to_clan extends warrior_run_away_to_clan
{
	public warrior_aggressive_run_away_to_clan(final NpcInstance actor){super(actor);}
