...
public class party_leader_ag_casting_ddmagic_stone extends party_leader_casting_ddmagic_stone
{
	public int MeleeAttackerAg = -1;

	public party_leader_ag_casting_ddmagic_stone(final NpcInstance actor){super(actor);}
