...
public class warrior_ag_casting_3skill_magical extends warrior_casting_3skill_magical
{
	public warrior_ag_casting_3skill_magical(final NpcInstance actor){super(actor);}
	...
	protected void onEvtSeeCreature(Creature creature)
	{
		...
		if (GetLifeTime() > 7 && InMyTerritory(actor) && (creature.isPlayer() || IsInCategory(Category.summon_npc_group, creature.getClassId())))
		{
			i6 = AiUtils.Rand(100);
			if (DistFromMe(creature) > 100 && i6 < 33 && p_state != State.ATTACK)
			{
