...
public class CastleSiegeEvent extends SiegeEvent<Castle, SiegeClanObject> {
    ...
    static {
        try {
            if (OtherCustom.allowAdditionalCastleRewards) {
    ...
    private static void parseAdditionalRewards() throws Exception {
        ...
        int i = 1;
        additionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.gludioCastleRewards, CastleRewardTemplate.class));
        additionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.dionCastleRewards, CastleRewardTemplate.class));
        additionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.giranCastleRewards, CastleRewardTemplate.class));
        additionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.orenCastleRewards, CastleRewardTemplate.class));
        additionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.adenCastleRewards, CastleRewardTemplate.class));
        additionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.innadrilCastleRewards, CastleRewardTemplate.class));
        additionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.goddardCastleRewards, CastleRewardTemplate.class));
        additionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.runeCastleRewards, CastleRewardTemplate.class));
        additionalRewards.put(i, Util.parseTemplateConfig(OtherCustom.shuttgartCastleRewards, CastleRewardTemplate.class));
    }

    private static void parseLeaderAdditionalRewards() throws Exception {
        leaderAdditionalRewards = new HashMap<>();
        int i = 1;
        leaderAdditionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.gludioLeaderCastleRewards, CastleRewardTemplate.class));
        leaderAdditionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.dionLeaderCastleRewards, CastleRewardTemplate.class));
        leaderAdditionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.giranLeaderCastleRewards, CastleRewardTemplate.class));
        leaderAdditionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.orenLeaderCastleRewards, CastleRewardTemplate.class));
        leaderAdditionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.adenLeaderCastleRewards, CastleRewardTemplate.class));
        leaderAdditionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.innadrilLeaderCastleRewards, CastleRewardTemplate.class));
        leaderAdditionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.goddardLeaderCastleRewards, CastleRewardTemplate.class));
        leaderAdditionalRewards.put(i++, Util.parseTemplateConfig(OtherCustom.runeLeaderCastleRewards, CastleRewardTemplate.class));
        leaderAdditionalRewards.put(i, Util.parseTemplateConfig(OtherCustom.shuttgartLeaderCastleRewards, CastleRewardTemplate.class));
    }
...
//				manageAddReward(winner.getLeader().getPlayer(), template);
    ...
    private void setNextSiegeTime() {
        ZonedDateTime nextSiegeTime = ResidenceConfig.CASTLE_VALIDATION_DATE.with(DayOfWeek.SUNDAY)
                .withHour(getResidence().getLastSiegeDate().isEqual(Residence.MIN_SIEGE_DATE)
                        ? _hourOfDay == 0? Rnd.get(ResidenceConfig.CASTLE_SELECT_HOURS) : _hourOfDay : getResidence().getLastSiegeDate().getHour());
    ...
    @Override
    public boolean canResurrect(final Creature active, final Creature target, boolean force, final boolean quiet) {
        ...
        force = force || targetPlayer.getClan() == resurectPlayer.getClan();
