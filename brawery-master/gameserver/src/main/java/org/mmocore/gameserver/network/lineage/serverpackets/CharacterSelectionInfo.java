...
public class CharacterSelectionInfo extends GameServerPacket {
    ...
    protected void writeData() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int weaponR=charInfoPackage.getPaperdollVisualItemId(Inventory.PAPERDOLL_RHAND);
            int weaponLR=charInfoPackage.getPaperdollVisualItemId(Inventory.PAPERDOLL_LRHAND);
            int setId=charInfoPackage.getPaperdollVisualItemId(Inventory.PAPERDOLL_CHEST);
            int helmetId=0, cloakId = 0;
            ...
            if(weaponR!=0)
                writeD(DressWeaponHolder.getInstance().getWeapon(weaponR).getWeaponId());
            else
            ...
            if(setId!=0){
                ...
                writeD(dress.getGloves());
                writeD(dress.getChest());
                writeD(dress.getLegs());
                writeD(dress.getFeet());
                helmetId = dress.getHelmet();
                cloakId = dress.getCloak();
            }
            else{
            ...
            if(weaponLR!=0)
                writeD(DressWeaponHolder.getInstance().getWeapon(weaponLR).getWeaponId());
            else
