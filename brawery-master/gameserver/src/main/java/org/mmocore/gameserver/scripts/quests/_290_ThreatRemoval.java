        ...
        if (event.equalsIgnoreCase("quest_accept")) {
            ...
            if (GetMemoState == 1 && st.ownItemCount(q_id_tag_of_xel) >= 400) {
                ...
                if (i0 == 0)
                    ...
                    st.giveReward(scrl_of_ench_am_s, 1, true);
                else if (i0 >= 4 && i0 < 6)
                    st.giveReward(scrl_of_ench_am_s, 2, true);
                else if (i0 >= 6 && i0 < 7)
                    st.giveReward(scrl_of_ench_am_s, 3, true);
                else if (i0 >= 7 && i0 < 9)
                    st.giveReward(high_ore_of_fire, 1, true);
                else
                    st.giveReward(high_ore_of_fire, 2, true);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (GetMemoState == 1)
            if (npcId == xel_trainer_mage) {
                int i0 = Rnd.get(1000);
                if (i0 < 932) {
                    st.giveItems(q_id_tag_of_xel, 1, true);
