...
public class SpecialCamera extends GameServerPacket {
    ...
    public SpecialCamera(final GameObject creature, final int force, final int angle1, final int angle2, final int time,
                         final int duration, final int relYaw, final int relPitch, final int isWide, int unk)
    {
        this(creature, force, angle1, angle2, time, duration, relYaw, relPitch, isWide, 0, 0);
    }
