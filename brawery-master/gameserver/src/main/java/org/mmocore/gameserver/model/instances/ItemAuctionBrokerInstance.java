...
public final class ItemAuctionBrokerInstance extends NpcInstance {
    ...
    public void showChatWindow(final Player player, final int val, final Object... arg) {
        final HtmlMessage packet;
        switch (getNpcId()) {
            case 32320:
                packet = new HtmlMessage(this).setFile("pts/auction_manager/auction_manager1001.htm");
                //showChatWindow(player, "pts/auction_manager/auction_manager1001.htm");
                break;
            case 32321:
                packet = new HtmlMessage(this).setFile("pts/auction_manager/auction_manager2001.htm");
                //showChatWindow(player, "pts/auction_manager/auction_manager2001.htm");
                break;
            case 32322:
                packet = new HtmlMessage(this).setFile("pts/auction_manager/auction_manager3001.htm");
        ...
        if(packet == null)
            return;
        packet.addVariable("ITEM_BROKER_ITEM_SEARCH", ServicesConfig.ITEM_BROKER_ITEM_SEARCH);
