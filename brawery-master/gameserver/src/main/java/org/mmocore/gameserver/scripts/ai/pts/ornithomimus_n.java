...
public class ornithomimus_n extends warrior_physicalspecial
{
	public ornithomimus_n(final NpcInstance actor){super(actor);}
			...
			switch (code_info.getCode())
			{
				case 0:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						...
						if (i4 < 327 && AiUtils.OwnItemCount(target, 8779) <= 1)
						{
