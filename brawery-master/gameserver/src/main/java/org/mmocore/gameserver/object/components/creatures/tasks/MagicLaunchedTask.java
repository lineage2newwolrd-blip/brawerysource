...
public class MagicLaunchedTask extends RunnableImpl {
    ...
    public void runImpl() {
        ...
        character.broadcastPacket(new MagicSkillLaunched(character.getObjectId(), character.isNpc()? castingSkill.getId() : castingSkill.getDisplayId(), castingSkill.getDisplayLevel(), intObjIds));
    }
}