    ...
    public void onBypassFeedback(Player player, String command) {
        ...
        if (command.startsWith("menu_select?ask=198&")) {
            if (command.endsWith("reply=1")) {
                showChatWindow(player, "quests/_198_SevenSignsEmbryo/priest_jeina_q0198_01.htm");
            } else if (command.endsWith("reply=2")) {
                showChatWindow(player, "quests/_198_SevenSignsEmbryo/priest_jeina_q0198_02.htm");
                reflection.collapse();
            } else if (command.endsWith("reply=3")) {
                showChatWindow(player, "quests/_198_SevenSignsEmbryo/priest_jeina_q0198_02a.htm");
            }
        } else {
