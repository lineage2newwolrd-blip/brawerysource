...
public class warrior_ag_run_away_physicalspecial extends warrior_run_away_physicalspecial
{
	public warrior_ag_run_away_physicalspecial(final NpcInstance actor){super(actor);}
