...
public class warrior_ag_physicalspecial_stone extends warrior_physicalspecial_stone
{
	public int MeleeAttackerAg = -1;

	public warrior_ag_physicalspecial_stone(final NpcInstance actor){super(actor);}
