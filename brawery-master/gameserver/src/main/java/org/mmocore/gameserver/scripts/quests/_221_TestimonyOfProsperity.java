...
public class _221_TestimonyOfProsperity extends Quest {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("30104-04.htm")) {
            ...
            if (st.ownItemCount(OldAccountBook) > 0 && st.ownItemCount(BlessedSeed) > 0 && st.ownItemCount(EmilysRecipe) > 0 && st.ownItemCount(LilithsElvenWafer) > 0) {
                st.setCond(2);
                st.setState(STARTED);
            }
        ...
        } else if (event.equalsIgnoreCase("30534-03a.htm") && st.ownItemCount(ADENA_ID) >= 5000) {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        int cond = st.getCond();
        if (npcId == Parman) {
            if (st.ownItemCount(MarkOfProsperity) != 0) {
                htmltext = "completed";
                st.exitQuest(true);
            } else if (cond == 0) {
            ...
            } else if (cond == 3 && st.ownItemCount(ParmansInstructions) > 0) {
                if (st.getPlayer().getLevel() < 38) {
            ...
            } else if (cond == 4 && st.ownItemCount(RingOfTestimony2st) > 0 && st.ownItemCount(ParmansLetter) > 0 && st.ownItemCount(MaphrTabletFragment) == 0) {
            ...
            if (st.ownItemCount(CollectionLicense) == 0) {
                htmltext = "30531-01.htm";
            } else if (st.ownItemCount(CollectionLicense) > 0) {
                if (st.ownItemCount(ReceiptOfContribution1st) > 0 && st.ownItemCount(ReceiptOfContribution2st) > 0 && st.ownItemCount(ReceiptOfContribution3st) > 0 && st.ownItemCount(ReceiptOfContribution4st) > 0 && st.ownItemCount(ReceiptOfContribution5st) > 0) {
            ...
            } else if (cond >= 1 && st.ownItemCount(RingOfTestimony1st) > 0 && st.ownItemCount(OldAccountBook) > 0 && st.ownItemCount(CollectionLicense) == 0) {
                htmltext = "30531-06.htm";
            } else if (cond >= 1 && st.ownItemCount(RingOfTestimony2st) > 0) {
                htmltext = "30531-07.htm";
            }
        } else if (npcId == Spiron && cond == 1 && st.ownItemCount(CollectionLicense) > 0) {
            if (st.ownItemCount(Lockirins1stNotice) > 0) {
                htmltext = "30532-01.htm";
                st.takeItems(Lockirins1stNotice, -1);
            } else if (st.ownItemCount(ReceiptOfContribution1st) == 0 && st.ownItemCount(ContributionOfShari) == 0) {
                htmltext = "30532-02.htm";
            } else if (st.ownItemCount(ContributionOfShari) > 0) {
                st.takeItems(ContributionOfShari, -1);
                st.giveItems(ReceiptOfContribution1st, 1);
                htmltext = "30532-03.htm";
            } else if (st.ownItemCount(ReceiptOfContribution1st) > 0) {
                htmltext = "30532-04.htm";
            }
        } else if (npcId == Shari && cond == 1 && st.ownItemCount(CollectionLicense) > 0 && st.ownItemCount(Lockirins1stNotice) == 0 && st.ownItemCount(ReceiptOfContribution1st) == 0) {
            if (st.ownItemCount(ContributionOfShari) == 0) {
                st.giveItems(ContributionOfShari, 1);
                htmltext = "30517-01.htm";
            } else {
                htmltext = "30517-02.htm";
            }
        } else if (npcId == Balanki && cond == 1 && st.ownItemCount(CollectionLicense) > 0) {
            if (st.ownItemCount(Lockirins2stNotice) > 0) {
                htmltext = "30533-01.htm";
                st.takeItems(Lockirins2stNotice, -1);
            } else if (st.ownItemCount(ReceiptOfContribution2st) == 0 && (st.ownItemCount(ContributionOfMion) == 0 || st.ownItemCount(ContributionOfMaryse) == 0)) {
                htmltext = "30533-02.htm";
            } else if (st.ownItemCount(ContributionOfMion) != 0 && st.ownItemCount(ContributionOfMaryse) != 0) {
            ...
            } else if (st.ownItemCount(ReceiptOfContribution2st) > 0) {
                htmltext = "30533-04.htm";
            }
        } else if (npcId == Mion && cond == 1 && st.ownItemCount(CollectionLicense) > 0 && st.ownItemCount(Lockirins2stNotice) == 0 && st.ownItemCount(ReceiptOfContribution2st) == 0) {
            if (st.ownItemCount(ContributionOfMion) == 0) {
                htmltext = "30519-01.htm";
                st.giveItems(ContributionOfMion, 1);
            } else {
                htmltext = "30519-02.htm";
            }
        } else if (npcId == Redbonnet && cond == 1 && st.ownItemCount(CollectionLicense) > 0 && st.ownItemCount(Lockirins2stNotice) == 0 && st.ownItemCount(ReceiptOfContribution2st) == 0) {
            if (st.ownItemCount(MarysesRequest) == 0 && st.ownItemCount(ContributionOfMaryse) == 0) {
                htmltext = "30553-01.htm";
                st.giveItems(MarysesRequest, 1);
            } else if (st.ownItemCount(MarysesRequest) > 0 && st.ownItemCount(ContributionOfMaryse) == 0) {
                if (st.ownItemCount(AnimalSkin) < 100) {
            ...
            } else if (st.ownItemCount(ContributionOfMaryse) > 0) {
                htmltext = "30553-04.htm";
            }
        } else if (npcId == Keef && cond == 1 && st.ownItemCount(CollectionLicense) > 0) {
            if (st.ownItemCount(Lockirins3stNotice) > 0) {
                htmltext = "30534-01.htm";
                st.takeItems(Lockirins3stNotice, -1);
            } else if (st.ownItemCount(ReceiptOfContribution3st) == 0 && st.ownItemCount(ProcurationOfTorocco) == 0) {
                htmltext = "30534-02.htm";
            } else if (st.ownItemCount(ReceiptOfContribution3st) == 0 && st.ownItemCount(ProcurationOfTorocco) > 0) {
                htmltext = "30534-03.htm";
            } else if (st.ownItemCount(ReceiptOfContribution3st) > 0) {
                htmltext = "30534-04.htm";
            }
        } else if (npcId == Torocco && cond == 1 && st.ownItemCount(CollectionLicense) > 0 && st.ownItemCount(Lockirins3stNotice) == 0 && st.ownItemCount(ReceiptOfContribution3st) == 0) {
            if (st.ownItemCount(ProcurationOfTorocco) == 0) {
                htmltext = "30555-01.htm";
            } else if (st.ownItemCount(ProcurationOfTorocco) > 0) {
                htmltext = "30555-03.htm";
            }
        } else if (npcId == Filaur && cond == 1 && st.ownItemCount(CollectionLicense) > 0) {
            if (st.ownItemCount(Lockirins4stNotice) > 0) {
                htmltext = "30535-01.htm";
                st.takeItems(Lockirins4stNotice, -1);
            } else if (st.ownItemCount(ReceiptOfContribution4st) == 0 && st.ownItemCount(ReceiptOfBolter) == 0) {
                htmltext = "30535-02.htm";
            } else if (st.ownItemCount(ReceiptOfBolter) > 0 && st.ownItemCount(ReceiptOfContribution4st) == 0) {
                htmltext = "30535-03.htm";
                st.takeItems(ReceiptOfBolter, -1);
                st.giveItems(ReceiptOfContribution4st, 1);
            } else if (st.ownItemCount(CollectionLicense) > 0 && st.ownItemCount(ReceiptOfContribution4st) > 0 && st.ownItemCount(ReceiptOfBolter) == 0 && st.ownItemCount(Lockirins4stNotice) == 0) {
                htmltext = "30535-04.htm";
            }
        } else if (npcId == Bolter && cond == 1 && st.ownItemCount(CollectionLicense) > 0 && st.ownItemCount(Lockirins4stNotice) == 0 && st.ownItemCount(ReceiptOfContribution4st) == 0) {
            if (st.ownItemCount(ReceiptOfBolter) == 0) {
                htmltext = "30554-01.htm";
                st.giveItems(ReceiptOfBolter, 1);
            } else {
                htmltext = "30554-02.htm";
            }
        } else if (npcId == Arin && cond == 1 && st.ownItemCount(CollectionLicense) > 0) {
            if (st.ownItemCount(Lockirins5stNotice) > 0) {
                htmltext = "30536-01.htm";
                st.takeItems(Lockirins5stNotice, -1);
            } else if (st.ownItemCount(ReceiptOfContribution5st) == 0 && st.ownItemCount(ContributionOfToma) == 0) {
        ...
        } else if (npcId == Toma && cond == 1 && st.ownItemCount(CollectionLicense) > 0 && st.ownItemCount(Lockirins5stNotice) == 0 && st.ownItemCount(ReceiptOfContribution5st) == 0) {
            if (st.ownItemCount(ContributionOfToma) == 0) {
            ...
            if (cond == 1) {
                if (st.ownItemCount(BlessedSeed) == 0) {
                    htmltext = "30597-01.htm";
                } else {
                    htmltext = "30597-03.htm";
                }
            } else if (st.ownItemCount(RingOfTestimony2st) > 0) {
                htmltext = "30597-04.htm";
            }
        } else if (npcId == Wilford) {
            if (cond == 1) {
                if (st.ownItemCount(LilithsElvenWafer) == 0 && st.ownItemCount(CrystalBrooch) == 0) {
                    htmltext = "30005-01.htm";
                } else if (st.ownItemCount(LilithsElvenWafer) == 0 && st.ownItemCount(CrystalBrooch) > 0) {
                    htmltext = "30005-05.htm";
                } else if (st.ownItemCount(LilithsElvenWafer) > 0) {
            ...
            if (cond == 1) {
                if (st.ownItemCount(CrystalBrooch) > 0 && st.ownItemCount(LilithsElvenWafer) == 0) {
            ...
            if (cond == 1) {
                if (st.ownItemCount(BrightsList) == 0 && st.ownItemCount(EmilysRecipe) == 0 && st.ownItemCount(MandragoraBouquet) == 0) {
                    htmltext = "30466-01.htm";
                } else if (st.ownItemCount(MandragoraPetal) < 20 || st.ownItemCount(CrimsonMoss) < 10) {
                ...
                } else if (st.ownItemCount(MandragoraBouquet) > 0 && st.ownItemCount(EmilysRecipe) == 0) {
                    htmltext = "30466-06.htm";
                } else if (st.ownItemCount(EmilysRecipe) > 0) {
            ...
            if (cond == 1) {
                if (st.ownItemCount(MandragoraBouquet) != 0) {
            ...
            } else if (cond == 8 && st.ownItemCount(KeyOfTitan) > 0) {
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (cond == 7 && st.ownItemCount(StakatoShell) >= 20 && st.ownItemCount(ToadLordSac) >= 10 && st.ownItemCount(SpiderThorn) >= 10) {
            st.setCond(8);
            st.setState(STARTED);
        }
        return null;
