...
public class ai_boss05_pirates_zombie_b extends warrior_aggressive_physicalspecial
{
	public int different_level_9_attacked = 295895041;
	public int different_level_9_see_spelled = 276234241;

	public ai_boss05_pirates_zombie_b(final NpcInstance actor)
	{
		super(actor);
		PhysicalSpecial = 266534917;
	}
