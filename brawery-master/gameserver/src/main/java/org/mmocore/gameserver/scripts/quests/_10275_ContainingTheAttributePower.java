...
public class _10275_ContainingTheAttributePower extends Quest {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("quest_accept_weber") && GetMemoStateEx != 1) {
            ...
            st.giveReward(q_ore_of_holy, 2, true);
            st.takeItems(q_Attribute_manager_weapon1, -1);
            st.takeItems(q_elemental_piece_water, -1);
            ...
            st.giveReward(q_ore_of_unholy, 2, true);
            st.takeItems(q_Attribute_manager_weapon1, -1);
            st.takeItems(q_elemental_piece_water, -1);
            st.addExpAndSp(202160, 20375);
            st.exitQuest(false);
            ...
            st.giveReward(q_ore_of_fire, 2, true);
            st.takeItems(q_Attribute_manager_weapon1, -1);
            st.takeItems(q_elemental_piece_water, -1);
            st.addExpAndSp(202160, 20375);
            st.exitQuest(false);
            ...
            st.giveReward(q_ore_of_water, 2, true);
            st.takeItems(q_Attribute_manager_weapon1, -1);
            st.takeItems(q_elemental_piece_water, -1);
            st.addExpAndSp(202160, 20375);
            st.exitQuest(false);
            ...
            st.giveReward(q_ore_of_wind, 2, true);
            st.takeItems(q_Attribute_manager_weapon1, -1);
            st.takeItems(q_elemental_piece_water, -1);
            st.addExpAndSp(202160, 20375);
            st.exitQuest(false);
            ...
            st.giveReward(q_ore_of_earth, 2, true);
            st.takeItems(q_Attribute_manager_weapon1, -1);
            st.takeItems(q_elemental_piece_water, -1);
            st.addExpAndSp(202160, 20375);
            st.exitQuest(false);
