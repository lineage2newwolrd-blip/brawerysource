...
public class dark_terror extends warrior_aggressive_casting_curse
{
	public dark_terror(final NpcInstance actor){super(actor);}
		...
		if (!AiUtils.IsNull(code_info))
		{
			switch (code_info.getCode())
			{
				case 0:
				{
					...
					{
						if (AiUtils.Rand(100) < 26 && AiUtils.OwnItemCount(target, 1159) < 3)
						{
