...
public class varka_silenos_medium extends wizard_ag_casting_clanbuff_rangedd_curse_stone
{
	public varka_silenos_medium(final NpcInstance actor){super(actor);}
	...
	protected void onEvtDead(Creature attacker)
	{
		...
		target = attacker;
		if (AiUtils.HaveMemo(target, 605) == 1 && ((((AiUtils.OwnItemCount(target, 7211) >= 1 && AiUtils.OwnItemCount(target, 7217) < 100) || (AiUtils.OwnItemCount(target, 7212) >= 1 && AiUtils.OwnItemCount(target, 7217) < 200)) || (AiUtils.OwnItemCount(target, 7213) >= 1 && AiUtils.OwnItemCount(target, 7217) < 300)) || (AiUtils.OwnItemCount(target, 7214) >= 1 && AiUtils.OwnItemCount(target, 7217) < 400)))
		{
