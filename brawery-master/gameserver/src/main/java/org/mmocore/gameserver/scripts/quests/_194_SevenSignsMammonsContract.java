    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (npcId == sir_gustaf_athebaldt) {
            ...
            if (event.equalsIgnoreCase("reply_1")) {
                ...
                if (GetMemoState == 10 && talker_transformID != 124 && st.ownItemCount(q_gloves_of_native) < 1) {
                    if (st.getPlayer().isTransformed() || st.getPlayer().isMounted()) {
                        st.getPlayer().sendPacket(SystemMsg.YOU_ALREADY_POLYMORPHED_AND_CANNOT_POLYMORPH_AGAIN);
                        return null;
                    }
        ...
        switch (id) {
            ...
            case STARTED:
                if (npcId == sir_gustaf_athebaldt) {
                    ...
                    else if (GetMemoState == 10 && talker_transformID != 124 && st.ownItemCount(q_gloves_of_native) < 1)
                    ...
                    if (GetMemoState == 10) {
                        if (talker_transformID == 124)
                            ...
                            htmltext = "native_kuda_q0194_05.htm";
                    } else if (GetMemoState == 10 && st.ownItemCount(q_gloves_of_native) >= 1 && talker_transformID == 124)
