...
public class Hero {
    ...
    private static Map<Integer, StatsSet> _activeHeroes;
    ...
    private void init() {
        ...
        _activeHeroes = new ConcurrentHashMap<>();
        ...
        try {
            ...
            while (rset.next()) {
                ...
                if(!_activeHeroes.containsKey(charId) && hero.getInteger(ACTIVE) == 1)
                    _activeHeroes.put(charId, hero);
            }
        ...
        try {
            heroRewards = Util.parseTemplateConfig(OtherCustom.heroRewards, HeroRewardTemplate.class);
        } catch (Exception e) {
    ...
    public void updateHeroes(final int id) {
        ...
        try {
            ...
            for (final Integer heroId : _heroes.keySet()) {
                ...
                if(_activeHeroes!=null && !_activeHeroes.containsKey(heroId) && hero.getInteger(ACTIVE) == 1)
                    _activeHeroes.put(heroId, hero);
            }
        } catch (SQLException e) {
