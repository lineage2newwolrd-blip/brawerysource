...
public abstract class ItemTemplate extends StatTemplate {
    ...
    protected SkillEntry _unequip_skill = null;
    ...
    public SkillEntry getUnequipSkills() {
        return _enchant4Skill;
    }

    public void setUnequipSkill(final SkillEntry skill) {
        _unequip_skill = skill;
    }
    public SkillEntry getUnequipSkill() {
    ...
    /**
     * Проверяет, является ли данный инстанс предмета хербом в хейне
     * @return true если предмет является хербом
     */
    public boolean isAncientHerb()
    {
        return _itemId == 14824 || _itemId == 14825 || _itemId == 14826 || _itemId == 14827;
    }
