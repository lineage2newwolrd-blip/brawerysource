...
public class wizard_ag_casting_clanbuff_rangedd_curse extends wizard_casting_clanbuff_rangedd_curse
{
	public wizard_ag_casting_clanbuff_rangedd_curse(final NpcInstance actor){super(actor);}
	...
	protected void onEvtSeeCreature(Creature creature)
	{
		...
		if (AiUtils.OwnItemCount(creature, FriendShip1) >= 1)
		{
		}
