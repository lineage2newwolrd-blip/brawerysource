...
public class warrior_ag_casting_3skill_magical3 extends warrior_casting_3skill_magical3
{
	public warrior_ag_casting_3skill_magical3(final NpcInstance actor){super(actor);}
	...
	protected void onEvtSeeCreature(Creature creature)
	{
		...
		if (GetLifeTime() > 7 && InMyTerritory(actor) && p_state == State.MOVE_AROUND)
		{
			...
			if (DistFromMe(creature) > 100 && AiUtils.Rand(100) < 33)
			{
