...
public class party_leader_ag_couple_captain_nurse extends party_leader_couple_captain_nurse
{
	public party_leader_ag_couple_captain_nurse(final NpcInstance actor){super(actor);}
