...
public class tracker_skeleton_leader extends warrior_aggressive
{
	public tracker_skeleton_leader(final NpcInstance actor){super(actor);}
		...
		while (!AiUtils.IsNull(code_info = always_list.Next()))
		{
			switch (code_info.getCode())
			{
				...
				case 2:
				{
					...
					{
						c1 = GetLastAttacker();
						if (AiUtils.HaveMemo(c_quest2, 403)!=0 && AiUtils.OwnItemCount(c_quest2, 1183) < 10 && i_quest2 == 1 && AiUtils.Rand(10) < 3)
						{
