...
public class ant_captain extends warrior_aggressive
{
	public ant_captain(final NpcInstance actor){super(actor);}
			...
			switch (code_info.getCode())
			{
				...
				case 2:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						...
						if (AiUtils.HaveMemo(c1, 213)!=0 && AiUtils.OwnItemCount(c1, 2649) == 1 && AiUtils.OwnItemCount(c1, 2656) == 0)
						{
							if (AiUtils.Rand(100) < 100)
							{
								...
								GiveItem1(c1, 2656, 1);
								SoundEffect(c1, "ItemSound.quest_middle");
								if (AiUtils.OwnItemCount(c1, 2654) >= 1 && AiUtils.OwnItemCount(c1, 2655) >= 1 && AiUtils.OwnItemCount(c1, 2657) >= 1)
								{
