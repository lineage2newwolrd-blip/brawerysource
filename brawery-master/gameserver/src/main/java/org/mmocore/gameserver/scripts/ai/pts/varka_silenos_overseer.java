...
public class varka_silenos_overseer extends wizard_ag_casting_clanbuff_rangedd_curse_stone
{
	public varka_silenos_overseer(final NpcInstance actor){super(actor);}
