...
public class seal_arch_angel_r extends warrior_ag_casting_3skill_magical2_r
{
	public seal_arch_angel_r(final NpcInstance actor){super(actor);}
			...
			switch (code_info.getCode())
			{
				...
				case 1:
				{
					...
					if (!AiUtils.IsNull(target) && DistFromMe(target) <= 1500)
					{
						...
						{
							GiveItem1(target, 7586, 13);
							SoundEffect(target, "ItemSound.quest_itemget");
						}
						else
						{
							GiveItem1(target, 7586, 12);
							SoundEffect(target, "ItemSound.quest_itemget");
						}
					}
					break;
