...
public class party_private_ag_physicalspecial extends party_private_physicalspecial
{
	public party_private_ag_physicalspecial(final NpcInstance actor){super(actor);}
