...
public abstract class AbstractAI extends RunnableImpl {
    ...
    public final void notifyEvent(final CtrlEvent evt, final Object arg0, final Object arg1, final Object arg2, final Object arg3) {
        notifyEvent(evt, new Object[]{arg0, arg1, arg2, arg3});
    }
    ...
    public void notifyEvent(final CtrlEvent evt, final Object[] args) {
        ...
        switch (evt) {
            ...
            case EVT_SCRIPT_EVENT:
                if (args[0] instanceof ScriptEvent)
