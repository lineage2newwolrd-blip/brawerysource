...
public class warrior_aggressive_casting_enchant_clan extends warrior_casting_enchant_clan
{
	public warrior_aggressive_casting_enchant_clan(final NpcInstance actor){super(actor);}
	...
	protected void onEvtSeeCreature(Creature creature)
	{
		...
		{
			if (i_ai1 == 0 && AiUtils.Rand(100) < 33)
			{
