...
public class party_leader_ag_patrol_casting_ddmagic extends party_leader_patrol_casting_ddmagic
{
	public party_leader_ag_patrol_casting_ddmagic(final NpcInstance actor){super(actor);}
