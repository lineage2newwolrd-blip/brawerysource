...
public class warrior_aggressive_physicalspecial extends warrior_physicalspecial
{
	public warrior_aggressive_physicalspecial(final NpcInstance actor){super(actor);}
