...
public class varka_silenos_archmage extends warrior_ag_berserker_physicalspecial_stone
{
	public varka_silenos_archmage(final NpcInstance actor){super(actor);}
