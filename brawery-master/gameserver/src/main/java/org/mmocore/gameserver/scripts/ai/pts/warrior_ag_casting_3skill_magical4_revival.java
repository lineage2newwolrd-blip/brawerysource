...
public class warrior_ag_casting_3skill_magical4_revival extends warrior_casting_3skill_magical4_revival
{
	public warrior_ag_casting_3skill_magical4_revival(final NpcInstance actor){super(actor);}
	...
	protected void onEvtSeeCreature(Creature creature)
	{
		...
		{
			if (i_ai1 == 0 && AiUtils.Rand(100) < 33 && AiUtils.FloatToInt(actor.currentHp / actor.getMaxHp() * 100) > 50 && p_state != State.ATTACK)
			{
