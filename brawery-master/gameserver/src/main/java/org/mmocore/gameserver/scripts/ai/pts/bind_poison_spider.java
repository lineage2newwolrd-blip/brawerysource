...
public class bind_poison_spider extends warrior_aggressive_casting_curse
{
	public bind_poison_spider(final NpcInstance actor){super(actor);}
		...
		while (!AiUtils.IsNull(code_info = always_list.Next()))
		{
			switch (code_info.getCode())
			{
				case 1:
				{
					...
					{
						c1 = GetLastAttacker();
						if (AiUtils.HaveMemo(c_quest0, 410) == 1 && AiUtils.OwnItemCount(c_quest0, 1240) == 1 && i_quest0 == 1 && AiUtils.OwnItemCount(c_quest0, 1242) < 5)
						{
							GiveItem1(c_quest0, 1242, 1);
							if (AiUtils.OwnItemCount(c_quest0, 1242) >= 4 && AiUtils.OwnItemCount(c_quest0, 1241) == 1)
							{
								SetFlagJournal(c_quest0, 410, 5);
								ShowQuestMark(c_quest0, 410);
							}
							if (AiUtils.OwnItemCount(c_quest0, 1242) >= 4)
							{
