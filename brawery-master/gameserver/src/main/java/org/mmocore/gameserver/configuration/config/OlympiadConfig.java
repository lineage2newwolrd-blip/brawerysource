...
public class OlympiadConfig {
    ...
    @Setting(name = "EnableTeamClass")
    public static boolean OLYMPIAD_TEAM_ENABLE;
    ...
    @Setting(minValue = 1, maxValue = 7, name = "OlympiadWorkDays")
    public static int[] OLYMPIAD_WORK_DAYS;
    ...
    @Setting(name = "OlympiadEnemyInfo")
    public static boolean OLYMPIAD_ENEMY_INFO;

    @Setting(name = "OlympiadPointTransfer", canNull = true)
    ...
    @Setting(name = "OlympiadCustomEffect", method="parseOlyBuffs", canNull = true)
    public static Map<Integer, Integer> OLYMPIAD_CUSTOM_EFFECT;

    private void parseOlyBuffs(String value) {
        OLYMPIAD_CUSTOM_EFFECT = Util.parseConfigMap(value, Integer.class, Integer.class);
    }
}
