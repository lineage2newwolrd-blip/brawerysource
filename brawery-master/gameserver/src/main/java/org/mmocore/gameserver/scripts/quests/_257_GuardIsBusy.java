                ...
                if (npcId == gilbert) {
                    if (st.ownItemCount(orc_amulet) < 1 && st.ownItemCount(orc_necklace) < 1 && st.ownItemCount(werewolf_fang) < 1)
                        ...
                        if (st.ownItemCount(orc_amulet) + st.ownItemCount(orc_necklace) + st.ownItemCount(werewolf_fang) >= 10)
                            st.giveReward(ADENA_ID, 10 * st.ownItemCount(orc_amulet) + 20 * st.ownItemCount(orc_necklace) + 20 * st.ownItemCount(werewolf_fang) + 1000, true);
                        else
                            st.giveReward(ADENA_ID, 10 * st.ownItemCount(orc_amulet) + 20 * st.ownItemCount(orc_necklace) + 20 * st.ownItemCount(werewolf_fang), true);
