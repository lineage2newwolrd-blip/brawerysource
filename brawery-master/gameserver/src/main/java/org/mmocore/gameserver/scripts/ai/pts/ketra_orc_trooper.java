...
public class ketra_orc_trooper extends warrior_ag_berserker_physicalspecial_stone
{
	public ketra_orc_trooper(final NpcInstance actor){super(actor);}
	...
	protected void onEvtDead(Creature attacker)
	{
		...
		target = attacker;
		if (AiUtils.HaveMemo(target, 611) == 1 && ((((((AiUtils.OwnItemCount(target, 7221) + AiUtils.OwnItemCount(target, 7222) + AiUtils.OwnItemCount(target, 7223) + AiUtils.OwnItemCount(target, 7224) + AiUtils.OwnItemCount(target, 7225)) == 0 && AiUtils.OwnItemCount(target, 7226) < 100) || (AiUtils.OwnItemCount(target, 7221) >= 1 && AiUtils.OwnItemCount(target, 7226) < 200)) || (AiUtils.OwnItemCount(target, 7222) >= 1 && AiUtils.OwnItemCount(target, 7226) < 300)) || (AiUtils.OwnItemCount(target, 7223) >= 1 && AiUtils.OwnItemCount(target, 7226) < 300)) || (AiUtils.OwnItemCount(target, 7224) >= 1 && AiUtils.OwnItemCount(target, 7226) < 400)))
		{
