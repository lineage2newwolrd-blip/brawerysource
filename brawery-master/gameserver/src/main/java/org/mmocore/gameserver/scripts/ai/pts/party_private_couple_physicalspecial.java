...
public class party_private_couple_physicalspecial extends party_private_couple
{
	public int PhysicalSpecial = 264241153;

	public party_private_couple_physicalspecial(final NpcInstance actor){super(actor);}
	...
	protected void onEvtAttacked(Creature attacker, int skill_name_id, int skill_id, int damage)
	{
		...
		if (attacker.isPlayer() || IsInCategory(Category.summon_npc_group, attacker.getClassId()))
		{
			...
			{
				if (actor.currentHp < actor.getMaxHp() * 0.200000f && i6 < 33 && i_ai0 == 0 && top_desire_target == attacker)
				{
