...
public class warrior_ag_ps_patrol_weapon_equipped extends warrior_ps_patrol_weapon_equipped
{
	public warrior_ag_ps_patrol_weapon_equipped(final NpcInstance actor){super(actor);}
