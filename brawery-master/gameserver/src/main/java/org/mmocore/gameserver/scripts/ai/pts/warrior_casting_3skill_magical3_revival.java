...
public class warrior_casting_3skill_magical3_revival extends warrior_casting_3skill_magical3
{
	public int silhouette = 1020130;
	public String ai_type = "warrior";

	public warrior_casting_3skill_magical3_revival(final NpcInstance actor){super(actor);}
