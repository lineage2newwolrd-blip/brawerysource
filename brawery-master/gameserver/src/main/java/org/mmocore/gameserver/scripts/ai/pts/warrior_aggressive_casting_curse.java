...
public class warrior_aggressive_casting_curse extends warrior_casting_curse
{
	public warrior_aggressive_casting_curse(final NpcInstance actor){super(actor);}
