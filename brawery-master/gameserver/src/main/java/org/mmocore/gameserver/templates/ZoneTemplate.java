...
import org.mmocore.gameserver.model.zone.ZoneTarget;
...
public class ZoneTemplate {
    ...
    private final String _enterСustomMessage;
    private final String _leaveСustomMessage;

    /**
     * Раса на которую применим эффект
     */
    private final PlayerRace _affectRace;
    ...
    public ZoneTemplate(final StatsSet set) {
        ...
        _enterСustomMessage = set.getString("entering_custom_message", null);
        _leaveСustomMessage = set.getString("leaving_custom_message", null);

        _target = ZoneTarget.valueOf(set.getString("target", "pc"));
        _affectRace = "all".equals(set.getString("affect_race", "all")) ? null : PlayerRace.valueOf(set.getString("affect_race"));
        ...
        if (s != null) {
            ...
            skill = SkillTable.getInstance().getSkillEntry(Integer.parseInt(sk[0]), Integer.parseInt(sk[1]));
        }
        _skill = skill;
    ...
    public String getEnterСustomMessage() {
        return _enterСustomMessage;
    }

    public String getLeaveСustomMessage() {
        return _leaveСustomMessage;
    }
