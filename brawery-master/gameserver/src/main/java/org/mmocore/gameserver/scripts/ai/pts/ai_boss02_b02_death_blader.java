...
public class ai_boss02_b02_death_blader extends warrior_aggressive_casting_ddmagic
{
	public int different_level_9_attacked = 295895041;
	public int different_level_9_see_spelled = 276234241;

	public ai_boss02_b02_death_blader(final NpcInstance actor){super(actor);}

	@Override
	protected void onEvtSpawn()
	{

		AddTimerEx(4002, 3000);
		super.onEvtSpawn();
	}
