...
public class warrior_berserker_physicalspecial_stone extends warrior_berserker_physicalspecial
{
	public int DeBuff1 = 295895041;

	public warrior_berserker_physicalspecial_stone(final NpcInstance actor){super(actor);}
