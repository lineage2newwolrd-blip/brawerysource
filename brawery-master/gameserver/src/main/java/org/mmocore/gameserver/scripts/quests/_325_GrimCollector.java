...
public class _325_GrimCollector extends Quest {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("guard_curtiz_q0325_03.htm")) {
            ...
            if (pieces(st) > 0) {
                st.giveReward(ADENA_ID, 30 * st.ownItemCount(ZOMBIE_HEAD) + 20 * st.ownItemCount(ZOMBIE_HEART) + 20 * st.ownItemCount(ZOMBIE_LIVER) + 50 * st.ownItemCount(SKULL) + 15 * st.ownItemCount(RIB_BONE) + 10 * st.ownItemCount(SPINE) + 10 * st.ownItemCount(ARM_BONE) + 10 * st.ownItemCount(THIGH_BONE) + 2000 * st.ownItemCount(COMPLETE_SKELETON), true);
            ...
            st.giveReward(ADENA_ID, 2000 * st.ownItemCount(COMPLETE_SKELETON), true);
            st.takeItems(COMPLETE_SKELETON, -1);
