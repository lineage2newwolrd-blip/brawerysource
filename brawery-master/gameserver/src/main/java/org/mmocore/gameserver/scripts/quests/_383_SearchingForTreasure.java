    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (npcId == trader_espen) {
            if (event.equalsIgnoreCase("quest_accept")) {
                ...
                st.giveReward(ADENA_ID, 1000, true);
            ...
            if (event.equalsIgnoreCase("reply_1"))
                if (st.ownItemCount(key_of_thief) == 0)
                    ...
                    if (i0 < 5)
                        ...
                        st.giveReward(scrl_of_ench_am_d, 1, true);
                    else if (i0 < 28)
                        st.giveReward(scrl_of_ench_am_c, 1, true);
                    else
                        i1 = i1 + 500;
                    int i2 = Rnd.get(1000);
                    if (i2 < 25)
                        st.giveReward(dye_s1c3_c, 1, true);
                    else if (i2 < 50)
                        st.giveReward(dye_s1d3_c, 1, true);
                    else if (i2 < 75)
                        st.giveReward(dye_c1s3_c, 1, true);
                    else if (i2 < 100)
                        st.giveReward(dye_c1c3_c, 1, true);
                    else if (i2 < 125)
                        st.giveReward(dye_d1s3_c, 1, true);
                    else if (i2 < 150)
                        st.giveReward(dye_d1c3_c, 1, true);
                    else if (i2 < 175)
                        st.giveReward(dye_i1m3_c, 1, true);
                    else if (i2 < 200)
                        st.giveReward(dye_i1w3_c, 1, true);
                    else if (i2 < 225)
                        st.giveReward(dye_m1i3_c, 1, true);
                    else if (i2 < 250)
                        st.giveReward(dye_m1w3_c, 1, true);
                    else if (i2 < 275)
                        st.giveReward(dye_w1i3_c, 1, true);
                    else if (i2 < 300)
                        st.giveReward(dye_w1m3_c, 1, true);
                    else
                        i1 = i1 + 300;
                    int i3 = Rnd.get(100);
                    if (i3 < 4)
                        st.giveReward(emerald, 1, true);
                    else if (i3 < 8)
                        st.giveReward(blue_onyx, 2, true);
                    else if (i3 < 12)
                        st.giveReward(onyx, 2, true);
                    else if (i3 < 16)
                        st.giveReward(q_loot_4, 2, true);
                    else if (i3 < 20)
                        st.giveReward(q_loot_7, 1, true);
                    else if (i3 < 25)
                        st.giveReward(q_loot_10, 1, true);
                    else if (i3 < 27)
                        st.giveReward(q_loot_13, 1, true);
                    else
                        i1 = i1 + 500;
                    int i4 = Rnd.get(100);
                    if (i4 < 20)
                        ...
                        i1 = i1 + 500;
                    st.giveReward(ADENA_ID, i1, true);
                }
        return htmltext;
    }
