...
public class wizard_ag_heretic_ddmagic_curse extends wizard_heretic_ddmagic_curse
{
	public wizard_ag_heretic_ddmagic_curse(final NpcInstance actor){super(actor);}
	...
	protected void onEvtSeeCreature(Creature creature)
	{
		...
		if (GetLifeTime() > 7 && InMyTerritory(actor) && GetHateInfoCount() == 0 && (creature.isPlayer() || IsInCategory(Category.summon_npc_group, creature.getClassId())))
		{
