...
public class warrior_aggressive_casting_sleep_magic extends warrior_casting_sleep_magic
{
	public warrior_aggressive_casting_sleep_magic(final NpcInstance actor){super(actor);}
