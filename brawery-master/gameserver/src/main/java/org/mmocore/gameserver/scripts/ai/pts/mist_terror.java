...
public class mist_terror extends warrior_aggressive
{
	public mist_terror(final NpcInstance actor){super(actor);}
	...
	protected void onEvtDead(Creature attacker)
	{
		...
		if (!AiUtils.IsNull(code_info))
		{
			if (code_info.getCode() == 0)
			{
				...
				{
					if (AiUtils.Rand(100) < 23 && AiUtils.OwnItemCount(target, 1159) < 3)
					{
