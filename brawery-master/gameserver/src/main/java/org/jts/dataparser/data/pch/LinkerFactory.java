...
public class LinkerFactory {
    ...
    private static Map<String, String> npc_pch = new HashMap<>();
    ...
    public static void addNpcPch(String id, String value) {
        npc_pch.put(id, value);
    }
    ...
    public String npcPchName(int npcPTSId) {
        return npc_pch.get(String.valueOf(npcPTSId));
    }
}