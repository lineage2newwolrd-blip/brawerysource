...
public class Rename
{
	...
	public void changesex(Player player, NpcInstance npc, String[] arg)
	{
		...
		try
		{
			...
			offline.setInt(1, player.getSex() == PlayerSex.FEMALE ? 0 : 1);
		...
		Log.add("Character " + '(' + player.getObjectId() + ") " + player + " sex changed to " + (player.getSex() == PlayerSex.FEMALE ? "male" : "female"), "renames");
	}
