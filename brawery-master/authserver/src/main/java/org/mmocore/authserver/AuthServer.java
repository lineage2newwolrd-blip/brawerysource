...
import org.mmocore.authserver.network.xmlrpc.handler.WorldHandler;
...
public class AuthServer {
    ...
    public AuthServer() throws Exception {
        ...
        if(LoginConfig.XML_RPC_SERVER_ENABLED) {
            ...
            xmlRpcServer.setpUser(LoginConfig.XML_RPC_USER);
            xmlRpcServer.setpPassword(LoginConfig.XML_RPC_PASSWORD);
